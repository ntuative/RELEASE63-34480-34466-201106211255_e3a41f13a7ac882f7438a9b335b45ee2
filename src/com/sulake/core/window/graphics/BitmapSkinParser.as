   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_349 = SkinLayoutEntity.const_627;
                  break;
               case "move":
                  _loc5_.var_349 = SkinLayoutEntity.const_347;
                  break;
               case "strech":
                  _loc5_.var_349 = SkinLayoutEntity.const_636;
                  break;
               case "tiled":
                  _loc5_.var_349 = SkinLayoutEntity.const_325;
                  break;
               case "center":
                  _loc5_.var_349 = SkinLayoutEntity.const_550;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_350 = SkinLayoutEntity.const_627;
                  break;
               case "move":
                  _loc5_.var_350 = SkinLayoutEntity.const_347;
                  break;
               case "strech":
                  _loc5_.var_350 = SkinLayoutEntity.const_636;
                  break;
               case "tiled":
                  _loc5_.var_350 = SkinLayoutEntity.const_325;
                  break;
               case "center":
                  _loc5_.var_350 = SkinLayoutEntity.const_550;
            }
         }
