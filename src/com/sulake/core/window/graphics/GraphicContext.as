package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2000:uint = 0;
      
      public static const const_850:uint = 1;
      
      public static const const_1235:uint = 2;
      
      public static const const_787:uint = 4;
      
      public static const const_1809:uint = 8;
      
      public static const const_1716:uint = 16;
      
      public static const const_2149:uint = 64;
      
      public static const const_2218:uint = 128;
      
      public static const const_1306:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1235:
               ...
               break;
            case GraphicContext.const_1809:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1716:
            ...
            case GraphicContext.const_1306:
               break;
            case GraphicContext.const_2000:
               break;
            default:
         ...
         if(this.var_912)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2230,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2230,16777215);
                  }
                  var_356 += bitmap.width * bitmap.height * 4;
               }
