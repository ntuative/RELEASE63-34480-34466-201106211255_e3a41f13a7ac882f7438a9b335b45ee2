package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1041:uint = 8;
      
      private static const const_1469:String = "skin";
      
      private static const const_1468:String = "bitmap";
      
      private static const const_1464:String = "fill";
      
      private static const const_1465:String = "text";
      
      private static const const_1466:String = "label";
      
      private static const const_1467:String = "shape";
      ...
      private var var_2405:Dictionary;
      
      private var var_2404:Dictionary;
      
      private var var_2403:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2405 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1762,this.var_2405);
         this.var_2404 = new Dictionary();
         this.var_2403 = new Dictionary();
         StateCodeTable.fillTables(this.var_2404,this.var_2403);
         this.var_430 = new Dictionary();
         this.var_430[const_1469] = BitmapSkinRenderer;
         this.var_430[const_1468] = BitmapDataRenderer;
         this.var_430[const_1464] = FillSkinRenderer;
         this.var_430[const_1465] = TextSkinRenderer;
         this.var_430[const_1466] = LabelRenderer;
         this.var_430[const_1467] = ShapeSkinRenderer;
         this.var_430[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_430[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_355 == null)
         {
            var_355 = new Array();
            var_355.push(WindowState.const_75);
            var_355.push(WindowState.const_89);
            var_355.push(WindowState.const_94);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3001 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1762[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_946[param1] = new Array(const_1041);
         }
         this.var_946[param1][param2] = param3;
         if(this.var_945[param1] == null)
         {
            this.var_945[param1] = new Array(const_1041);
         }
         this.var_945[param1][param2] = param4;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_945[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_102)
