package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_309:Function;
      
      protected var var_1404:int;
      
      protected var var_1403:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1404 *= 0.75;
         this.var_1403 *= 0.75;
         if(Math.abs(this.var_1404) <= 1 && Math.abs(this.var_1403) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_309 != null)
         {
            this.var_309(this.var_1404,this.var_1403);
         }
      }
