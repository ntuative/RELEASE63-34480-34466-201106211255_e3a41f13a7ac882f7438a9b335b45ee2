package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_729:Point;
      
      protected var var_1600:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_729);
         this._window.offset(this.var_729.x - this._offset.x,this.var_729.y - this._offset.y);
      }
