package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_436)
         {
            this.var_436.removeEventListener(WindowEvent.const_312,this.scrollBarEventProc);
            this.var_436.removeEventListener(WindowEvent.const_282,this.scrollBarEventProc);
            this.var_436 = null;
         }
         if(this.var_1192)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_436)
         {
            ...
            if(this.var_436)
            {
               this.var_436.addEventListener(WindowEvent.const_312,this.scrollBarEventProc);
               this.var_436.addEventListener(WindowEvent.const_282,this.scrollBarEventProc);
            }
         }
         return this.var_436;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_282)
         {
            this.hideScrollBar();
         }
      }
