package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2242:Boolean = false;
      ...
      protected var var_1408:Boolean = false;
      
      protected var var_2243:int = 0;
      
      protected var var_2241:int = 0;
      
      protected var var_1409:Number;
      
      protected var var_1411:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_189 = var_505 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_407,WindowStyle.const_102,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1408;
      }
      ...
      {
         return new Rectangle(this.var_739 * this.maxScrollH,this.var_737 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_739 = param1;
            this._container.x = -this.var_739 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_62);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_589,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_557,param1);
            }
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_180:
               if(this.var_1410)
               {
                  this.var_1409 = this.var_2243 - _loc3_;
                  this.var_1411 = this.var_2241 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1409 != 0 && this.var_122 != 0)
                     {
                        this.scrollH += this.var_1409 / this.var_122;
                     }
                  }
                  else if(this.var_1411 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1411 / this.var_108;
                  }
                  this.var_2243 = _loc3_;
                  this.var_2241 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_264:
               if(this.var_1410)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1409,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1411);
                  }
                  this.var_1410 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1137 && !this.var_602 && this._container)
         {
            this.var_602 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_394,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1384);
         }
         if(this.var_1137 != PropertyDefaults.const_1243)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_754,this.var_1137,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1774);
         }
         if(this.var_510 != PropertyDefaults.const_1164)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_940,this.var_510,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1933);
         }
         if(this.var_1408 != PropertyDefaults.const_1253)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_746,this.var_1408,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1896);
         }
         if(this.var_740 != PropertyDefaults.const_1376)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_842,this.var_740,PropertyStruct.const_127,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1992);
         }
         if(this.var_738 != PropertyDefaults.const_1271)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1007,this.var_738,PropertyStruct.const_127,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_394:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_940:
               ...
               case PropertyDefaults.const_754:
                  this.var_1137 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_842:
                  this.var_740 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_1007:
                  this.var_738 = _loc2_.value as Number;
                  break;
            }
         }
