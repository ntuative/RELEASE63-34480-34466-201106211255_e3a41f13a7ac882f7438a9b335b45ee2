package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1690:uint = 500;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1235,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_828 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_19 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_351,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_778,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1958);
         _loc1_.push(this.var_1402 != PropertyDefaults.const_1334 ? new PropertyStruct(PropertyDefaults.const_901,this.var_1402,PropertyStruct.const_37,true) : PropertyDefaults.const_1938);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1226 ? new PropertyStruct(PropertyDefaults.const_799,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1782);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1383 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1718);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_901:
                  this.var_1402 = _loc2_.value as Boolean;
                  if(this.var_1402)
                  {
               ...
               case PropertyDefaults.const_778:
                  ...
                  break;
               case PropertyDefaults.const_1375:
