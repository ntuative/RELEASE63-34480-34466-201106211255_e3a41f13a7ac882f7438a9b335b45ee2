package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1008:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1249 == param2)
         {
            return;
         }
         param1.var_1249 = param2;
         param1.var_1898 = null;
         if(param1.var_1249 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1249);
      ...
      {
         if(PropertyDefaults.const_985.indexOf(param1) > -1)
         {
            this.var_795 = param1;
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1211)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_999,this.var_795,PropertyStruct.const_51,true,PropertyDefaults.const_985));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_999)
            {
