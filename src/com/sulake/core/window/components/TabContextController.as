package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1655:String = "_SELECTOR";
      
      private static const const_1656:String = "_CONTENT";
       
      
      protected var var_1134:ITabSelectorWindow;
      
      protected var var_2240:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1134 = findChildByTag(const_1655) as ITabSelectorWindow;
            if(this.var_1134 != null)
            {
               this.var_1134.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2240 == null)
         {
            this.var_2240 = findChildByTag(const_1656) as IWindowContainer;
         }
      ...
      {
         return !!this.var_828 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1134.numSelectables;
      }
