package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_484,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_484 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_484,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_762 ? true : null;
         }
      ...
      {
         this.var_920 = param1;
         this._field.scrollH = this.var_920 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_920 * this.maxScrollH,this.var_600 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_935,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1171));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1240 ? new PropertyStruct(PropertyDefaults.const_786,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1274) : PropertyDefaults.const_1924);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_252,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1386 ? new PropertyStruct(PropertyDefaults.const_1221,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1157) : PropertyDefaults.const_1733);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_966) ? new PropertyStruct(PropertyDefaults.const_457,this._field.textColor,PropertyStruct.const_143,true) : PropertyDefaults.const_1356);
         ...
         _loc1_.push(this.var_44.left != PropertyDefaults.const_745 ? new PropertyStruct(PropertyDefaults.const_256,this.var_44.left,PropertyStruct.const_39,true) : PropertyDefaults.const_897);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_880 ? new PropertyStruct(PropertyDefaults.const_262,this.var_44.top,PropertyStruct.const_39,true) : PropertyDefaults.const_876);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_858 ? new PropertyStruct(PropertyDefaults.const_254,this.var_44.right,PropertyStruct.const_39,true) : PropertyDefaults.const_976);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_741 ? new PropertyStruct(PropertyDefaults.const_247,this.var_44.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_1015);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1230 ? new PropertyStruct(PropertyDefaults.const_927,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1777);
