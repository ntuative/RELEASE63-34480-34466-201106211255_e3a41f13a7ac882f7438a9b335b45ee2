package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1674:String = "_TITLE";
      
      private static const const_1675:String = "_HEADER";
      
      private static const const_1677:String = "_CONTENT";
      
      private static const const_1676:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1647:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1674) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1647 = findChildByTag(const_1675) as IHeaderWindow;
            if(!this.var_1647)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_205 = findChildByTag(const_1677) as IWindowContainer;
            if(!this.var_205)
            {
      ...
      {
         return findChildByTag(const_1676) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1126 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_287);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,_loc3_.left,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,_loc3_.top,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         return _loc1_;
      }
