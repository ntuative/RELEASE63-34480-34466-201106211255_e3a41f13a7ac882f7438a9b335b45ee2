package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_526)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_526)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_960,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1729);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1339)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_874,param1.toolTipDelay,PropertyStruct.const_252,true));
         }
         else
         {
