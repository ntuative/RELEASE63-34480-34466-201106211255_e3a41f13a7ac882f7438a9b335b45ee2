package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1336:String = "_EXCLUDE";
      
      public static const const_2267:String = "_INCLUDE";
      
      public static const const_2162:String = "_TEMP";
      
      private static const const_1454:String = "layout";
      
      private static const const_1035:String = "window";
      
      private static const const_1036:String = "variables";
      
      private static const const_1037:String = "filters";
      
      private static const const_681:String = "name";
      
      private static const const_1443:String = "style";
      
      private static const const_679:String = "params";
      
      private static const const_1450:String = "tags";
      ...
      private static const const_1447:String = "visible";
      
      private static const const_1449:String = "caption";
      ...
      private static const const_1445:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1452:String = "treshold";
      
      private static const const_1448:String = "children";
      
      private static const const_1455:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1451:String = "height_min";
      
      private static const const_1442:String = "height_max";
      
      private static const const_680:String = "true";
      
      private static const const_194:String = "0";
      
      private static const const_1446:String = "$";
      
      private static const const_1444:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1453:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1441:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1682:Dictionary;
      
      protected var var_2219:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1397,this.var_1398);
         this.var_1128 = new Dictionary();
         this.var_1682 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1128,this.var_1682);
         this.var_2219 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1441,const_50);
         return param1.replace(const_1453,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1682)
            {
               delete this.var_1682[_loc1_];
            }
            this.var_2219.dispose();
            this.var_2219 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1454)
         {
            _loc8_ = param1.child(const_1036);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1037).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1397[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_681,variables,"")));
         style = uint(this.parseAttribute(xml,const_1443,variables,style));
         params = uint(this.parseAttribute(xml,const_679,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1450,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1447,variables,visible.toString()) == const_680;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_679).length() > 0)
         {
            list = xml.child(const_679).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1449,variables,caption)));
         if(tag != const_50)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1036)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1455,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1451,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1442,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_680;
         blend = Number(this.parseAttribute(xml,const_1360,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1445,variables,window.clipping.toString()) == const_680;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1452,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1037).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1398[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1336) == -1)
                  {
