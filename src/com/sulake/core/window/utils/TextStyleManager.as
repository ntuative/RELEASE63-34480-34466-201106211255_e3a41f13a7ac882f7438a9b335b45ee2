package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_578:Array;
      ...
      private static const const_1680:String = "/*";
      
      private static const const_1681:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_578.indexOf(_loc4_.name) == -1)
            {
               var_578.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_719);
         if(countSubStrings(param1,const_718) != countSubStrings(param1,const_719))
         {
            throw new Error("Mismatching amount of \"" + const_718 + "\" versus \"" + const_719 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1680) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1681) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_718)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
