package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_357 = new Array();
            var_357[0] = MouseCursorType.const_375;
            var_357[1] = MouseCursorType.const_30;
            var_357[2] = MouseCursorType.const_375;
            var_357[3] = MouseCursorType.const_375;
            var_357[4] = MouseCursorType.const_375;
            var_357[5] = MouseCursorType.const_30;
            var_357[6] = MouseCursorType.const_375;
         }
         if(var_310 == null)
         {
            var_310 = new Array();
            var_310[0] = WindowState.const_91;
            var_310[1] = WindowState.const_92;
            var_310[2] = WindowState.const_87;
            var_310[3] = WindowState.const_75;
            var_310[4] = WindowState.const_57;
            var_310[5] = WindowState.const_94;
            var_310[6] = WindowState.const_89;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_264;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_70 = state.var_1388 as WindowController;
         this.var_188 = state.var_1387 as WindowController;
         this.var_180 = state.renderer;
         this.var_916 = state.var_1389;
         eventQueue.begin();
         this.var_733.x = -1;
         this.var_733.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_733.x || event.stageY != this.var_733.y)
            {
               this.var_733.x = event.stageX;
               this.var_733.y = event.stageY;
               array = new Array();
               this.var_95.groupParameterFilteredChildrenUnderPoint(this.var_733,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_70.getGlobalPosition(var_427);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_70 && !this.var_70.disposed)
                     {
                        ...
                        {
                           this.var_916.mouseEventReceived(event.type,this.var_70);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1388 = this.var_70;
         state.var_1387 = this.var_188;
         state.renderer = this.var_180;
         state.var_1389 = this.var_916;
      }
