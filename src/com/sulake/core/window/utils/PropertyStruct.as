package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_3032 = param3 == const_309 || param3 == const_166 || param3 == const_304 || param3 == const_291;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_37:
               return Boolean(this.var_192) == true ? "true" : "false";
            case const_304:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_309:
               ...
               _loc1_ = "<var key=\"" + this.var_617 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_291:
               ...
               break;
            case const_143:
               _loc1_ = "<var key=\"" + this.var_617 + "\" value=\"" + "0x" + uint(this.var_192).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_617 + "\" value=\"" + this.var_192 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
