package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_717:Map = new Map();
      
      private static const const_383:Map = new Map();
      
      private static var var_1346:Boolean = false;
      ...
      {
         return const_717.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1346)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_717.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1346 = true;
         }
