package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2026:uint = 1;
      
      protected static const const_2025:uint = 2;
      
      protected static const const_2024:uint = 4;
      
      protected static const const_2027:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1944:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1333:Boolean = false;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1333)
         {
            ...
            while(var_744.length < const_1911 && false)
            {
      ...
      {
         return !!this.var_1126 ? uint(this.var_1394 - this.var_2218) : uint(getTimer() - this.var_2218);
      }
      ...
      {
         if(this.var_1127 && !_disposed)
         {
            this.var_1127 = false;
            if(!this.var_1126 && this.var_261)
            {
               this.var_1394 = -1;
      ...
      {
         if(!this.var_1126 && !_disposed && this.var_1395 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_261,const_1944 - this.var_1395);
            if(this.var_3007)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_500 = LibraryLoader.name_5;
         ...
         if(this.var_500 == LibraryLoader.const_2027)
         {
         ...
         if(this.var_500 == LibraryLoader.name_5)
         {
