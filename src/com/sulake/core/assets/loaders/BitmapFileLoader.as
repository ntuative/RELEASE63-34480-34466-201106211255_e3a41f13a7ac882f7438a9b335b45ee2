package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1131 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_45 = new Loader();
         this.var_1132 = new LoaderContext();
         this.var_1132.checkPolicyFile = true;
         ...
         {
            this.var_45.load(param2,this.var_1132);
         }
      }
      ...
      {
         this.var_1131 = param1.url;
         var_354 = 0;
         this.var_45.load(param1,this.var_1132);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_354 < var_3029)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1131 + (this.var_1131.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_354),this.var_1132);
               return true;
            }
         }
         return false;
