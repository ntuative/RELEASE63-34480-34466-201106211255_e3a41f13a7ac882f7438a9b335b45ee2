package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1197:String = "AssetLibraryReady";
      
      public static const const_989:String = "AssetLibraryLoaded";
      
      public static const const_1968:String = "AssetLibraryUnloaded";
      
      public static const const_1959:String = "AssetLibraryLoadError";
      
      private static const const_681:String = "name";
      
      private static const const_1109:String = "asset";
      
      private static const const_1108:String = "param";
      ...
      private static var var_1968:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_552;
         this.var_464 = new Dictionary(false);
         this.var_551 = new Dictionary(false);
         this.var_1031 = new Dictionary(false);
         this.var_182 = new Dictionary(false);
         var_1029.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1110);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1109);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1108);
                  if(_loc11_.length())
                  {
      ...
      {
         if(this.var_668 == param1.url && this.var_1028)
         {
            if(!this.var_1030 && param2)
            {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_182)
         {
            delete this.var_182[_loc1_];
         }
         for(_loc1_ in this.var_1031)
         {
         ...
         this.var_1028 = false;
         this.var_668 = null;
         dispatchEvent(new Event(AssetLibrary.const_1968));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1031[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1224,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_182[struct.assetName] == null)
                  {
                     ++this.var_463;
                     this.var_465.push(struct.assetName);
                  }
                  this.var_182[struct.assetName] = asset;
               }
               else
               {
      ...
      {
         var _loc2_:IAsset = this.var_182[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_182)
         {
            _loc3_ = this.var_182[_loc2_];
      ...
      {
         return this.var_182[param1] != null || (this.var_667 != null ? this.var_667[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_182[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_182[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1968.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_464.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_464[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_464[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_464)
         {
            _loc3_ = AssetTypeDeclaration(this.var_464[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_464)
         {
            _loc4_ = AssetTypeDeclaration(this.var_464[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_1028 = true;
         dispatchEvent(new Event(AssetLibrary.const_989));
         dispatchEvent(new Event(AssetLibrary.const_1197));
         if(this.var_1030)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1959));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1110);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1109);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_681) && _loc3_.attribute(const_681).toString() == param1)
                  {
                     ...
                     _loc6_ = _loc3_.child(const_1108);
