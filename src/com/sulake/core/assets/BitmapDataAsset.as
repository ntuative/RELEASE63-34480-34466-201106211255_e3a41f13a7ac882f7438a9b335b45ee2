   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_117 is BitmapDataAsset)
         {
            ...
            this.var_1543 = BitmapDataAsset(this.var_117).var_1543;
            this.var_1544 = BitmapDataAsset(this.var_117).var_1544;
            if(this._bitmap != null)
            {
               this.var_117 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1543 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1544 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
