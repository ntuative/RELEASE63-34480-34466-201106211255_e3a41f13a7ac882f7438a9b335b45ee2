package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_461:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2185:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1206:uint = 4;
       
      
      protected var var_892:uint = 0;
      
      protected var var_1393:String = "";
      
      protected var var_2239:String = "";
      ...
      private var var_556:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_556 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_556.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_556.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1393 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1393);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1600 & const_1206)
         {
            if(_loc3_ == 0)
            {
               if(this.var_556.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1038 = false;
            this._events.dispatchEvent(new LockEvent(const_461,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_892 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_556.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_556.getStructByIndex(_loc8_);
