package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1620:String = "asset-libraries";
      
      private static const const_1624:String = "library";
      
      private static const const_1625:String = "service-libraries";
      
      private static const const_1628:String = "library";
      
      private static const const_1627:String = "component-libraries";
      
      private static const const_1621:String = "library";
      
      private static const const_1622:String = "error_data";
      
      private static const const_1623:String = "error_cat";
      
      private static const const_1626:String = "error_desc";
       
      
      private var var_397:LibraryLoaderQueue;
      
      private var var_834:IEventDispatcher;
      
      private var var_559:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_782:
               ...
               var_423.addChild(new ProfilerViewer(this.var_224));
               break;
            case Core.const_597:
      ...
      {
         return this.var_559 - this.getNumberOfFilesPending();
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1622,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1623,String(param3));
         ErrorReportStorage.setParameter(const_1626,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_834 = loadingEventDelegate;
         if(this.var_397 == null)
         {
         ...
         try
         {
            node = config.child(const_1620)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1210);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_834)
         {
            this.var_834.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_834)
         {
            ...
            this.var_834.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_834)
                  {
                     this.var_834.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_559 - this.var_397.length,this.var_559,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_224 ? 0 : this.var_1600 & 0;
         if(_loc3_ == Core.const_597)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_106)
         {
            ...
            {
               if(this.var_680[priority] < priority)
               {
                  ++this.var_680[priority];
                  skip = true;
               }
            }
            if(!skip)
