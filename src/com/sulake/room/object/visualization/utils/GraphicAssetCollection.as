package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private static const const_1508:int = 10;
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc5_.length > 0)
            {
               ...
               _loc12_ = this.var_365.getAssetByName(_loc6_);
               if(_loc12_ != null)
               {
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         if(_loc8_ == null)
         {
            _loc8_ = new BitmapDataAsset(this.var_365.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_365.setAsset(param1,_loc8_);
      ...
      public function disposeAsset(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_365.removeAsset(_loc3_);
               _loc3_.dispose();
            }
            _loc2_.dispose();
         }
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_642 != null)
         {
            if(param1 || this.var_642.length > const_1508)
            {
               for each(_loc2_ in this.var_642)
               {
