package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_2023:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2023 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1307 = this.var_2023.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1307)
         {
            this.var_1307.procedure = this.onButtonClick;
         }
         this.var_1308 = this.var_2023.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1308)
         {
            this.var_1308.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_289 >= this.var_73.length - 1)
         {
            this.var_1308.disable();
         }
         else
         {
            this.var_1308.enable();
         }
         if(this.var_289 <= 0)
         {
      ...
      {
         ++this.var_289;
         this.var_289 = Math.min(this.var_289,this.var_73.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_289;
         this.var_289 = Math.max(this.var_289,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_73[this.var_289][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_73[this.var_289][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_73[this.var_289][1]).value;
