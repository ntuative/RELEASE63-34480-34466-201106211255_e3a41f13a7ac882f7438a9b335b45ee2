package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1147.getValue());
         _loc2_.push(this.var_1146.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_92 = param2;
         this.var_1147 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1147.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1147.setValue(1);
         this.var_1146 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1146.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1146.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1147.setValue(_loc3_);
         this.var_1146.setValue(_loc4_);
      }
