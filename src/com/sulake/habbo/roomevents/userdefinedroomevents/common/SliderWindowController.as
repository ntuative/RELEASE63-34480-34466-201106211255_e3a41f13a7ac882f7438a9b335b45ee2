package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1310:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1310,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1063);
         }
      ...
      {
         return int(this.var_1778 * (Number(param1 - this._minValue) / (this.var_1310 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1778 * (this.var_1310 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1064)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_264)
            {
               this.var_1064 = false;
            }
         }
         if(!this.var_1064 || param1.type != WindowEvent.const_416)
         {
            return;
         }
         if(this.var_681 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_681 != 0)
            {
               _loc3_ = this.var_1063 + this.var_681;
      ...
      private function displaySlider() : void
      {
         ...
         {
            _loc2_.bitmap = new BitmapData(this.var_756.width,this.var_756.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_756,this.var_756.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            {
               _loc2_.bitmap = new BitmapData(this.var_757.width,this.var_757.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_757,this.var_757.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_756 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_757 = BitmapData(_loc2_.content);
      }
   }
}
