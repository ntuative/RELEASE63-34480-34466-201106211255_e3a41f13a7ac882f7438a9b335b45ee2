package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_348:int = 3;
      ...
      private var var_1196:SliderWindowController;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1196 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1196.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1196.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_764.hideAll(this.var_271);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_764.showAll(this.var_271);
         if(this.var_38 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_38);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1196.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_348)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1196.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1479) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1479 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_348)
         {
