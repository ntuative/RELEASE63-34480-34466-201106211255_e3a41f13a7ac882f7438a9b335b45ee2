package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_768:String = "RCL_LOADER_READY";
      
      private static const const_385:String = "RCL_PUBLICROOM_";
      
      private static const const_2083:int = 0;
      ...
      private static const const_721:String = "wall_place_holder";
      
      private static const const_720:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_480;
      
      private static const const_722:String = "room";
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2956 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2958 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1074)
         {
            return;
         }
         this.var_1662 = param1;
         this.var_2955 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2957 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1111.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_492 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_492.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_894.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_493.add(_loc3_,_loc4_);
               if(this.var_415[_loc7_] == null)
               {
                  this.var_415[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_720.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2954)
         {
            ...
            {
               this.var_1662.dispatchEvent(new Event(const_768));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_584 != null)
         {
            this.var_584.remove(param2);
            this.var_584.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_584 != null)
         {
            _loc2_ = this.var_584.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_344;
         }
         return RoomObjectCategoryEnum.const_140;
      }
      ...
      {
         return [const_480,const_721,const_720,const_722,TILE_CURSOR,const_1146];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_493.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_720.getValue(param1) as String;
      ...
      {
         return this.var_1111.getValue(param1) as String;
      }
      ...
      {
         var _loc2_:String = this.var_720.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_894.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_230 != null && this.var_230.hasWorldType(const_385 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_283 || param1 == RoomObjectVisualizationEnum.const_56 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_415[_loc4_] == null)
                     {
                        this.var_415[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_230 = this.var_1663.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_989,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2956.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1822);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2958.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_559,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_895.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_895.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_895.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_492.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_492[_loc2_] != null)
         {
            _loc3_ = this.var_492.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_385 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_385 + param1) == RoomObjectCategoryEnum.const_85)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_230.getWorldHeightScale(const_385 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_230 != null)
         {
            return this.var_230.getWorldScale(const_385 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_493.add(param1,param2);
      }
   }
}
