package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         {
            _loc3_ = this.var_811 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_479 > const_1095)
            {
               this.var_979 = const_1095 / _loc3_;
            }
            else
            {
               this.var_979 = const_479;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_811 && param1 >= this.var_1553 + this.var_979)
            {
               _loc3_ = param1 - this.var_1553;
               _loc4_ = _loc3_ / this.var_979;
               _loc5_ = 1;
               if(this.var_811 < _loc2_)
               {
                  _loc5_ = -1;
               }
               if(_loc4_ > _loc5_ * (this.var_811 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_811 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1553 = param1 - (_loc3_ - _loc4_ * this.var_979);
            }
         }
      }
   }
