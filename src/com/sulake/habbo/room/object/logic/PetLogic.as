package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_160,RoomObjectMoveEvent.const_424];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2737)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1568 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_451,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1980,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_736,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_217,_loc3_ + this.var_1044);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1999;
            _loc2_.setNumber(RoomObjectVariableEnum.const_245,this.var_1999);
            _loc2_.setNumber(RoomObjectVariableEnum.const_142,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1998;
            _loc2_.setNumber(RoomObjectVariableEnum.const_142,this.var_1998);
         }
         else
         {
            this.var_1044 += 45;
