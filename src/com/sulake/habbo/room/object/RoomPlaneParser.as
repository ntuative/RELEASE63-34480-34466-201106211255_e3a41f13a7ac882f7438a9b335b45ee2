package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_716:Number = 0.25;
      
      private static const const_1299:Number = 0.25;
      ...
      private var var_1639:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_712.push(_loc5_);
            _loc3_++;
         }
         this.var_279 = param1;
         this._height = param2;
         this.var_491 = this.var_279;
         this.var_488 = -1;
         this.var_489 = this._height;
         this.var_490 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_279 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_491 || param1 == this.var_488)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_489;
               ...
               if(param2 == this.var_489 || param2 == this.var_490)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_491;
                  while(_loc8_ < this.var_488)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < this._height)
         {
            ...
            {
               this.var_712[_loc2_][_loc8_] = this.var_140[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_140);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_952 = getFloorHeight(this.var_140);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_448,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1299 * this.var_1595;
         var _loc9_:Number = const_716 * this._floorThicknessMultiplier;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_299,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_716 * this._floorThicknessMultiplier;
            _loc19_ = _loc18_;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_299,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_299,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_299,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_299,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_279}" height="{this._height}" wallHeight="{this.var_1639}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc5_ = <tileRow/>;
            _loc6_ = this.var_712[_loc2_];
            _loc7_ = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1245;
         }
         var _loc2_:RoomPlaneData = this.var_155[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
