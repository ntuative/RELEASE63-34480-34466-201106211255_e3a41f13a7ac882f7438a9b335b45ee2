package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1557:String = "head";
      
      private static const const_698:int = 1;
      
      private static const const_1085:int = 1000;
      
      private static const const_1559:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1559) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_163)
         {
            ...
            this.var_2094 = _loc3_.getNumber(RoomObjectVariableEnum.const_269) > 0;
            ...
            {
               this.var_1894 = direction;
            }
            this.var_1448 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2385 = _loc3_.getNumber(RoomObjectVariableEnum.const_451);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_736);
            if(_loc9_ != this.var_1893)
            {
               this.var_1893 = _loc9_;
               this.var_2599 = this.var_1893.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_375 != null)
         {
            ...
            if(this.var_1448 > 0)
            {
               _loc2_ = param1 - this.var_1448;
               if(_loc2_ < const_1085)
               {
                  this.var_375.alpha = int(Math.sin(_loc2_ / const_1085 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_298)
         {
            ...
            this.setAnimationForIndex(const_1558,_loc3_);
         }
         if(param2 != this.var_1447)
         {
            this.var_1447 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_102,param2);
            this.setAnimationForIndex(const_1560,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2599);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_698)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_490.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_490[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.method_1(param1,this.var_1894);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1557)
            {
