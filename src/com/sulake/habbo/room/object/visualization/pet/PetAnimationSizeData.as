   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_710.add(_loc6_,_loc7_);
         ...
         if(this.var_710.getValue(this.var_879) == null)
         {
            return false;
         }
         return true;
      ...
      {
         if(this.var_710.getValue(param1) == null)
         {
            param1 = this.var_879;
         }
         return int(this.var_710.getValue(param1));
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_710.length)
         {
            return this.var_710.getKey(param1);
         }
         return this.var_879;
      }
