package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2164:int = 16777216;
      ...
      private var var_2121:int = 16777216;
      
      private var var_3059:int = 69069;
      
      private var var_3058:int = 5;
      ...
      {
         var _loc1_:int = this.var_3059 * this.var_2122 + this.var_3058;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2121;
         this.var_2122 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2121 * param2);
      }
   }
}
