   ...
   public class LayoutRasterizer
   {
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_958)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1462 = this.var_46.getValue(this.var_958);
         }
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_46.getValue(this.var_958);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1786 = RoomObjectVariableEnum.const_1190;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1786 = RoomObjectVariableEnum.const_1227;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_46.getValue(this.var_958);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2432 && param3 == this.var_2431)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1786);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_433.indexOf(_loc10_) >= 0 && this.var_957)
            {
               param1 = this.var_433.indexOf(_loc10_);
               if(this.var_622[param1] != "")
               {
                  _loc9_ = this.var_794.getAsset(this.var_622[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_623[param1] != -1)
               {
                  param2.alpha = this.var_623[param1];
               }
               this.var_433.splice(param1,1);
               this.var_622.splice(param1,1);
               this.var_623.splice(param1,1);
