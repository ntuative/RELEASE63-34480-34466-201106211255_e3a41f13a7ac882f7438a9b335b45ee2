package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1986:int = 16777215;
      
      public static const const_1740:int = 13421772;
      ...
      private var var_831:Rectangle = null;
      
      private var var_558:RoomPlaneBitmapMaskParser = null;
      
      private var var_1598:String = null;
      
      private var _floorType:String = null;
      
      private var var_1599:String = null;
      ...
      private var var_2774:int = 255;
      
      private var var_2775:int = 255;
      ...
      private var var_1826:int = -1000;
      
      private const const_2339:int = 250;
      
      private var var_1990:int = -1;
      
      private var var_1648:Number = 0.0;
      
      private var var_2773:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_333["null"] = false;
         this.var_333["null"] = true;
         this.var_333["null"] = true;
         this.var_333["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_831 = super.boundingRectangle;
         }
         return new Rectangle(this.var_831.x,this.var_831.y,this.var_831.width,this.var_831.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1595))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1595;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1223);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_448)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1986;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1740;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_2009)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_72,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_448)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1826 + this.const_2339 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_395.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2019)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2776 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2775 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2774 / 255);
         ...
         var_163 = _loc7_.getUpdateID();
         this.var_1826 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1990)
         {
            this.var_1990 = param1.updateId;
            this.var_831 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1648 || _loc3_.y != this.var_2773 || _loc3_.z != this.var_2772 || param1.scale != this.var_2018))
            {
               this.var_1648 = _loc3_.x;
               this.var_2773 = _loc3_.y;
               this.var_2772 = _loc3_.z;
               this.var_2018 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1371);
            if(_loc3_ != this.var_2020)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2020 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_794));
            if(_loc4_ != this.var_1300)
            {
               this.var_1300 = _loc4_;
               this.var_2776 = this.var_1300 & 255;
               this.var_2775 = this.var_1300 >> 8 & 255;
               this.var_2774 = this.var_1300 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1215));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_163 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1001));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_939));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_950));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_163 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1232);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1595))
            {
      ...
      {
         if(param1 != this.var_333["null"] || param2 != this.var_333["null"] || param3 != this.var_333["null"])
         {
            this.var_333["null"] = param1;
            this.var_333["null"] = param2;
            this.var_333["null"] = param3;
            this.var_395 = [];
            this.var_676 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_333[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1301;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_72 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_243)
                              {
