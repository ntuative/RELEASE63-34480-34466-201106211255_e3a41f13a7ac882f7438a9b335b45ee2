package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_2681:Number = 0;
      
      private var _color:uint = 0;
      
      private var var_1020:IPlaneRasterizer = null;
      
      private var var_802:PlaneMaskManager = null;
      ...
      private var var_815:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_343.assign(param3);
         this.var_344 = new Vector3d();
         this.var_344.assign(param4);
         this._normal = Vector3d.crossProduct(this.var_343,this.var_344);
      ...
      {
         return this._isVisible && this.var_815;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1020.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_815 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_382))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_343.length * param1.scale;
            _loc6_ = this.var_344.length * param1.scale;
            ...
            if(this.var_1020 != null)
            {
               _loc3_ = this.var_1020.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1946,this.var_2682,this.var_2677,this.var_2678,this.var_2680,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1990 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_815)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1478.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1478[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_181.z - originZ,this.var_135.z - originZ,this.var_98.z - originZ,this.var_134.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2681 = relativeDepth;
            this._isVisible = true;
            this.var_1990 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2679);
      ...
      {
         this.var_181.assign(param1.getScreenPosition(this.var_105));
         this.var_135.assign(param1.getScreenPosition(Vector3d.sum(this.var_105,this.var_344)));
         this.var_98.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_105,this.var_343),this.var_344)));
         this.var_134.assign(param1.getScreenPosition(Vector3d.sum(this.var_105,this.var_343)));
         ...
         var _loc2_:Number = Math.min(this.var_181.x,this.var_135.x,this.var_98.x,this.var_134.x);
         var _loc3_:Number = Math.max(this.var_181.x,this.var_135.x,this.var_98.x,this.var_134.x);
         var _loc4_:Number = Math.min(this.var_181.y,this.var_135.y,this.var_98.y,this.var_134.y);
         var _loc5_:Number = Math.max(this.var_181.y,this.var_135.y,this.var_98.y,this.var_134.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_181 == null || this.var_135 == null || this.var_98 == null || this.var_134 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_134.x - this.var_98.x;
         var _loc4_:Number = this.var_134.y - this.var_98.y;
         var _loc5_:Number = this.var_135.x - this.var_98.x;
         var _loc6_:Number = this.var_135.y - this.var_98.y;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1019)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < this.var_284.length)
            {
               _loc4_ = this.var_284[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_284.length == this.var_1021.length)
         {
            while(_loc1_ < this.var_284.length)
            {
               _loc4_ = this.var_284[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1021.length)
                  {
                     _loc7_ = this.var_1021[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_383.length > this.var_1558.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1019 || this.var_284.length == 0 && this.var_383.length == 0 && !this.var_382 || this.var_802 == null)
         {
            return;
         }
         ...
         if(this.var_382)
         {
            ...
            while(_loc5_ < this.var_284.length)
            {
               _loc3_ = this.var_284[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_343.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_344.length;
                  _loc12_ = _loc3_.type;
                  this.var_802.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1021.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_383.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_343.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_344.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_343.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_344.length;
                  this.var_79.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1558.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_382 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_250.copyChannel(param1,param1.rect,const_704,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_250.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_250,this.var_250.rect,const_704,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
