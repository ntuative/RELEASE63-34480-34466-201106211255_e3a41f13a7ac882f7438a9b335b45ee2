package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1889:int = const_388;
      ...
      public static const ALIGN_DEFAULT:int = const_119;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_119)
         {
            _loc5_ = new Rectangle(0,0,this.var_33.width,this.var_682);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_33.height - this.var_682,this.var_33.width,this.var_682);
         }
