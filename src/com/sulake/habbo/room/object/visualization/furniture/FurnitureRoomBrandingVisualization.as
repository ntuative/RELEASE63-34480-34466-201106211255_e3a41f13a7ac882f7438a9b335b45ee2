package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1638:String = "branded_image";
      
      private static const const_1635:int = 0;
      
      private static const const_1636:int = 1;
      
      private static const const_1639:int = 2;
      
      private static const const_1637:int = 3;
       
      
      protected var _imageUrl:String;
      
      protected var var_1407:Boolean = false;
      
      protected var var_1692:int;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1692 = _loc4_.getNumber(RoomObjectVariableEnum.const_614);
                  this.var_1691 = _loc4_.getNumber(RoomObjectVariableEnum.const_635);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_587);
               }
            }
         }
         if(!this.var_1407)
         {
            this.var_1407 = this.checkIfImageReady();
            if(this.var_1407)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_500);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1638)
         {
