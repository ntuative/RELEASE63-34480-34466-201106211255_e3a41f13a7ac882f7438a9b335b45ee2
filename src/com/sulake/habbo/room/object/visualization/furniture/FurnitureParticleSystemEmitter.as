package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1985:String = "cone";
      
      public static const const_1727:String = "plane";
      
      public static const const_1996:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_993 = 0;
         this.var_934 = false;
         this.init(0,0,0,this._direction,this.var_2559,this.var_992,this.var_2563,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2561)
         {
            switch(this.var_2558)
            {
               case const_1985:
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_993 < this.var_1521)
         {
            if(this.age % this.var_2562 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_993 < this.var_1521)
         {
            ...
            this.y = (2 - this.var_278) * this.y - (1 - this.var_278) * this.lastY + this.var_1875 * this.var_992 * this.var_992;
         ...
         for each(_loc2_ in this.var_370)
         {
            ...
            _loc2_.y = (2 - this.var_278) * _loc2_.y - (1 - this.var_278) * _loc2_.lastY + this.var_1875 * this.var_992 * this.var_992;
