package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_747:ColorTransform;
      
      private var var_1436:ColorTransform;
      
      private var var_1734:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_747 = new ColorTransform();
         this.var_747.alphaMultiplier = 1;
         this.var_1436 = new ColorTransform();
         this.var_1734 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_109 = this.var_1160[param1];
         this.var_934 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1733 >= 0)
         {
            this.var_267 = this._visualization.getSprite(this.var_1733);
            if(this.var_267 && this.var_267.asset)
            {
               ...
               if(this.var_96 == null)
               {
                  this.var_96 = this.var_267.asset.clone();
                  if(this.var_747.alphaMultiplier != 1)
                  {
                     this.var_613 = new BitmapData(this.var_96.width,this.var_96.height,true,4278190080);
                  }
               }
               this.var_2358 = -this.var_267.offsetX;
               this.var_2357 = -this.var_267.offsetY;
               this.var_267.asset = this.var_96;
            }
            if(this.var_96)
            {
            ...
            if(this.var_613)
            {
               this.var_613.fillRect(this.var_613.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_109.y * this.var_1161;
         }
         return 0;
      }
      ...
      {
         if(!this.var_109 || !this.var_267)
         {
            return;
         }
         if(this.var_96 && this.var_267.asset != this.var_96)
         {
            this.var_267.asset = this.var_96;
         }
         if(this.var_934)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_934 && this.var_109.hasIgnited)
         {
            this.var_934 = true;
         }
         _loc8_ = this.var_1185 * this.var_1161;
         this.var_109.update();
         if(this.var_934)
         {
            if(this.var_109.roomObjectSpriteId >= 0)
            ...
            {
               this.var_96.draw(this.var_613,this.var_1734,this.var_747,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_109.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2358 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1161;
               _loc4_ = this.var_2357 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1161;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1436.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_96.draw(_loc7_,this._translationMatrix,this.var_1436,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
