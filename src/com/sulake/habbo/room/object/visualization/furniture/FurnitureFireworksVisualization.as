package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_256:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_256 = this.var_700[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_256)
         {
            this.var_256.setAnimation(param1);
         }
      ...
      {
         if(this.var_256 && this.var_256.controlsSprite(param3))
         {
            return this.var_256.getSpriteYOffset(param1,param2,param3);
         }
