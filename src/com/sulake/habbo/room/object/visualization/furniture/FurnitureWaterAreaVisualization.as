package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1486:String = "shore";
      ...
      {
         if(this.var_2447 == param1 && this.var_2446 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1486)
            {
               this.var_1798 = _loc2_;
               this.var_2447 = param1;
               this.var_2446 = direction;
               return this.var_1798;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1190.indexOf(_loc2_) < 0)
            {
      ...
      {
         var _loc2_:* = null;
         if(this.var_522 == 0 || this.var_627 == 0)
         {
            ...
            this.var_522 = _loc2_.getNumber(RoomObjectVariableEnum.const_328);
            this.var_627 = _loc2_.getNumber(RoomObjectVariableEnum.const_441);
         }
         this.var_435 = [];
         this.var_626 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_522 * 2 + this.var_627 * 2)
         {
            this.var_435.push(false);
            this.var_626.push(ShoreMaskCreatorUtility.const_82);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_435,this.var_626,assetCollection);
      }
