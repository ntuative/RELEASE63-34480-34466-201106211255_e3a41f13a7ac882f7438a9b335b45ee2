package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1277 && this._animationData.hasAnimation(this.var_432,_loc2_))
         {
            return _loc2_;
         }
         return const_1277;
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_128 != null)
         {
            this.var_128.setLayerCount(this.var_679);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_128.animationOver || this.var_955)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_955)
         {
            return 0;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_955)
            {
               ...
               if(this.var_955 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_620)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
