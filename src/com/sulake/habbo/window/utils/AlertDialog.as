package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      protected static const const_1311:String = "_alert_button_custom";
      
      protected static const const_1413:String = "header_button_close";
      
      protected static const const_1862:String = "_alert_text_summary";
      ...
      protected var var_1728:String = "";
      
      protected var _disposed:Boolean = false;
      
      protected var var_309:Function = null;
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         if(_loc7_)
         {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_1311);
               _loc8_.dispose();
            }
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_510:
                  ...
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_176,null,null);
                     this.var_309(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
                  {
               ...
               case const_1413:
                  if(this.var_309 != null)
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_536,null,null);
                     this.var_309(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               ...
               case HabboAlertDialogFlag.const_1029:
                  ...
                  break;
               case HabboAlertDialogFlag.const_1311:
                  _loc2_ = this._window.findChildByName(const_1311) as IInteractiveWindow;
            }
         }
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1728;
         }
      }
