package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1520:uint = 1;
      ...
      private var var_1507:IEventDispatcher;
      
      private var var_1217:Boolean = false;
      
      private var var_1843:ProfilerOutput;
      
      private var var_1505:ProfilerAgentTask;
      
      private var var_1506:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_616 = this.var_214[const_1520];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1843)
            {
               this.var_1843 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1843.profiler = _loc3_;
            ...
            this.var_1506 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1506);
            this.var_1217 = true;
         }
      }
      ...
      {
         return this.var_616.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_616.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_214[param1].getDesktopWindow().getChildAt(this.var_616.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1507.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_470 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1507.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1507.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1923,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1995,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1788,param2.name + ": " + param2.toString());
            }
         }
      }
