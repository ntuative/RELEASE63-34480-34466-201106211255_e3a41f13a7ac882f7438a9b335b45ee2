package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1247:IDropMenuWindow;
      ...
      private var var_1532:ICheckBoxWindow;
      
      private var var_1531:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_361));
      ...
      public function populate() : void
      {
         ...
         this.var_1247 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1247);
         this.var_1247.procedure = this.onSelectTemplate;
         this.var_1001 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1532 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1531 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_749,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1001.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1908,_loc2_,this.var_512.text,"",""));
         if(this.var_1532.isSelected || this.var_1531.isSelected || this.var_1001.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1532.isSelected,this.var_1531.isSelected,this.var_1001.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1990);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1247.selection];
         if(_loc3_ != null)
         {
            this.var_725 = false;
