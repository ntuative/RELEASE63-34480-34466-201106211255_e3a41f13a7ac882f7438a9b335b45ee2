package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_851:IssueMessageData = null;
      
      private var var_850:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2835 = param2.pickerUserId;
         this.var_2836 = param2.pickerUserName;
         this.var_1501 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1324 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1325;
         }
         if(this.var_851 == null || param1.timeStamp < this.var_851.timeStamp)
         {
            this.var_851 = param1;
         }
         if(this.var_850 == null || param1.priority > this.var_850.timeStamp)
         {
            this.var_850 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1324 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1325;
            }
            if(this.var_851 == _loc2_)
            {
               this.var_851 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_850;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_851;
         if(_loc2_ == null)
         {
