package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1142:IDropMenuWindow;
      ...
      private var var_925:OffenceCategoryData;
      
      private var var_924:OffenceData;
      
      private var var_1143:IButtonWindow;
      
      private var var_1144:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1143 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1144 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1707;
         ...
         this.var_1142 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1142);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_925 != null;
         if(this.var_924 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_924.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_925 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_925.offences,this.var_1143,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1144,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1778;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1421,this.var_512.text,this.var_1420));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_925 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_924 = this.var_925.offences[_loc3_];
         this.var_512.text = this.var_924.msg;
         this.var_725 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1421,this.var_512.text,this.var_1420));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1142.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1421,this.var_512.text,this.getBanLength(),this.var_1420));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_725 || this.var_512.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1142.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1143.destroy();
            this.var_1143 = null;
         }
         if(this.var_1144 != null)
         {
            this.var_1144.destroy();
            this.var_1144 = null;
         }
         this.var_1142 = null;
         this.var_512 = null;
