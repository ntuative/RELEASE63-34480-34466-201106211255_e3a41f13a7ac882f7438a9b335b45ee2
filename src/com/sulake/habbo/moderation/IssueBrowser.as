package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2354:String = "my_issues";
      
      private const const_2355:String = "open_issues";
      
      private const const_2356:String = "picked_issues";
      
      private const const_2358:String = "closed_issues";
      ...
      private var var_419:IIssueBrowserView;
      
      private var var_2169:IIssueBrowserView;
      
      private var var_2170:IIssueBrowserView;
      
      private var var_2171:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_304 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_304.numTabItems)
            {
               _loc5_ = this.var_304.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_304 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_304 == null || this.var_304.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_304.selector.getSelectableByName("open_issues");
         this.var_304.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_419 == _loc2_)
         {
            return;
         }
         ...
         this.var_419.view.width = this.var_304.container.width;
         this.var_419.view.height = this.var_304.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2354:
               if(this.var_2169 == null)
               {
                  this.var_2169 = new MyIssuesView(this.issueManager,this,this.var_304.container);
               }
               return this.var_2169;
            case this.const_2355:
               if(this.var_2170 == null)
               {
                  this.var_2170 = new OpenIssuesView(this.issueManager,this,this.var_304.container);
               }
               return this.var_2170;
            case this.const_2356:
               if(this.var_2171 == null)
               {
                  this.var_2171 = new PickedIssuesView(this.issueManager,this,this.var_304.container);
               }
