package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1945:int = 200;
      ...
      {
         this.var_814 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1018.pop() as IWindowContainer;
         }
