package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1329:String = "issue_bundle_open";
      
      public static const const_941:String = "issue_bundle_my";
      
      public static const const_1159:String = "issue_bundle_picked";
      
      public static const const_1852:int = 15000;
       
      
      private var var_75:ModerationManager;
      
      private var var_728:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_728 = new IssueBrowser(this,this.var_75.windowManager,this.var_75.assets);
         this.var_1384 = [];
         this.var_1383 = [];
         this.var_1121 = new Map();
         this.var_2994 = parseInt(this.var_75.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2173 = new Timer(const_1852,0);
         this.var_2173.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2173.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1384 = this.var_1384.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_190 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1383 = this.var_1383.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_728 == null || !this.var_728.isOpen())
         {
            this.var_75.soundManager.playSound(HabboSoundTypesEnum.const_1168);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1122.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_1122.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_121)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1122.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2993++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1122.add(param1.issueId,_loc2_);
         ...
         if(this.var_1384.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_190)
         {
            _loc6_ = this.getBundles(const_941);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1383.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2994);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1121.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1121.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1122.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_121.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_121)
         {
            ...
            {
               case const_1329:
                  if(_loc4_.state == IssueMessageData.const_190)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1121.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1121.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1121.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
