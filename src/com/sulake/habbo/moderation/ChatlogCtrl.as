package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1975:int = 1000;
      ...
      private var var_1972:IMessageComposer;
      ...
      {
         this.var_823 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_822 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         ...
         this.var_36.connection.send(this.var_1972);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1973[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1574.getValue(param2.chatterName))
            {
               this.var_1574.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1574.getValue(_loc2_);
