package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      {
         this.var_1339 = new Point(Math.round(Math.random() * 0),Math.round(Math.random() * 0));
      }
      ...
      {
         return this.getFrame(param1) == const_1117;
      }
      ...
      {
         var _loc2_:int = param1 - this.var_2743;
         if(_loc2_ < 0)
         {
            return const_1610;
         }
         var _loc3_:int = Math.floor(_loc2_ / const_1609);
