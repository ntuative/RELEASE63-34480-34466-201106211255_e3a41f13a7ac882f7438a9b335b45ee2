package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_1003:int = 1000;
      
      private static const const_1600:int = 115;
      
      private static const const_1601:int = 25;
      
      private static const const_1114:int = 72;
      
      private static const const_1602:int = 4;
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this._questEngine.questController.onQuest(this.var_130);
         }
         ...
         this._window.findChildByName("quest_header_txt").caption = this._questEngine.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_469 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_469;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_469;
         this._window.findChildByName("more_info_txt").visible = this.var_469 && this._questEngine.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_469 && this._questEngine.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_469;
         this._window.findChildByName("desc_txt").visible = this.var_469;
         this._questEngine.notifications.setQuestTrackerHeight(!!this.var_469 ? int(const_1600) : int(const_1601));
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._questEngine.questController.questDetails.showDetails(this.var_130);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1428 = const_1003;
         this.refresh();
      }
      
      private function getDefaultLocationX() : int
      {
         return this._window.desktop.width - this._window.width - const_1602;
      }
