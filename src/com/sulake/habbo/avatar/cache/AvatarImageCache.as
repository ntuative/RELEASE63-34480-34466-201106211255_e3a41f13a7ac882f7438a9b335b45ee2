package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2049:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1456:IAvatarImage;
      ...
      private var var_362:IActiveActionData;
      ...
      private var var_431:BitmapDataAsset;
      
      private var var_948:BitmapData;
      
      private var var_2407:ByteArray;
      
      private var var_2406:ImageData;
      
      private var var_1081:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_754 == GeometryType.const_1394 && param1 == GeometryType.const_1162 || this.var_754 == GeometryType.const_1162 && param1 == GeometryType.const_1394)
         {
            this.var_754 = param1;
            this.var_96 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_362 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_362;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_362 || !this.var_362.definition))
         {
            if(this.var_362.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_362.definition.state + "." + this.var_362.actionParameter);
               _loc13_ = param2 - this.var_362.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_362.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_362 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_815)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_661)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1456.getFigure(),_loc5_,this.var_754,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_441 == null)
         {
            ...
            this.var_441 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_362);
            if(this.var_441 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_96)
         {
            this.var_96 = this._structure.getCanvas(this._scale,this.var_754);
            if(!this.var_96)
            {
               return null;
            }
            this.var_2408 = new Point(0,this.var_96.height - int(this.var_96.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1952[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_957 || _loc10_ == AvatarAction.const_415;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1450 = this.var_126.bodyPartId;
               this.var_194 = this.var_126.partType;
               this.var_1763 = this.var_126.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_126.flippedPartType != this.var_194)
                     {
                        this.var_194 = this.var_126.flippedPartType;
                     }
                  }
               }
               this.var_1451 = this._scale + "_" + this.var_126.action.assetPartDefinition + "_" + this.var_194 + "_" + this.var_1763 + "_" + _loc5_ + "_" + this._frame;
               this.var_431 = this._assets.getAssetByName(this.var_1451) as BitmapDataAsset;
               if(this.var_431 == null)
               {
                  this.var_1451 = this._scale + "_std_" + this.var_194 + "_" + this.var_1763 + "_" + _loc5_ + "_0";
                  this.var_431 = this._assets.getAssetByName(this.var_1451) as BitmapDataAsset;
               }
               if(!(!this.var_431 || !this.var_431.content))
               {
                  if(this.var_126.paletteMapId > -1)
                  {
                     this.var_1081 = this._structure.renderManager.paletteManager.getPalette(this.var_126.paletteMapId);
                     if(this.var_1081 != null)
                     {
                        this.var_948 = this.var_431.content as BitmapData;
                        this.var_193 = new BitmapData(this.var_948.width,this.var_948.height);
                        this.var_2407 = this.var_1081.colorize(this.var_948.getPixels(this.var_948.rect));
                        this.var_193.setPixels(this.var_193.rect,this.var_2407);
                     }
                     else
                     {
                        this.var_193 = (this.var_431.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1450 == AvatarBodyPartType.const_302 || this.var_1450 == AvatarBodyPartType.const_1970 || this.var_1450 == AvatarBodyPartType.const_1744) && this.var_126.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_193.colorTransform(this.var_193.rect,this.var_126.color.colorTransform);
                  }
                  if(this.var_126.isBlendable)
                  {
                     this.var_193.colorTransform(this.var_193.rect,this.var_126.blendTransform);
                  }
                  this.var_950 = this.var_431.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_60)
                     {
                  ...
                  this.var_2406 = new ImageData(this.var_193,this.var_950,_loc7_);
                  this.var_949.push(this.var_2406);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_949,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2408.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_60)
            {
         ...
         _loc8_ = this.var_949.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_949.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
