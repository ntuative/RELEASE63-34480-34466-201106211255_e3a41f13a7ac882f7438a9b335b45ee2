package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2352:String = "hd-99999-99999";
      ...
      private var var_898:PaletteManager;
      ...
      private var var_2160:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_625 = RenderMode.const_1724;
         ...
         this.var_120.add(AvatarType.const_130,_loc4_);
         ...
         this.var_120.add(AvatarType.const_56,_loc4_);
         ...
         this.var_898 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_347.init();
         this.var_898.init();
         _loc2_ = this.var_120.getValue(AvatarType.const_130) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_120.getValue(AvatarType.const_56) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_120.getValue(AvatarType.const_130) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1028)
         {
            if(this.var_2979 && this.var_2980 && this.var_2978)
            {
               this.var_1028 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_120.getValue(AvatarType.const_130) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2160)
         {
            this.var_2160 = new AvatarFigureContainer(this.const_2352);
         }
         this.var_260.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2160,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1741)
         {
            _loc6_ = !this.var_347.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_347.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_120.getValue(AvatarType.const_56) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_120.getValue(AvatarType.const_56);
      ...
      {
         var _loc3_:AvatarStructure = this.var_120.getValue(AvatarType.const_130) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_56:
               _loc3_ = this.var_120.getValue(AvatarType.const_56) as AvatarStructure;
               break;
            default:
