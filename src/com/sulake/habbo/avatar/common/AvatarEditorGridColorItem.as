package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1086:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_654 = _loc4_.content as BitmapData;
         ...
         this.var_998 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_654.width,this.var_654.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_654,this.var_654.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,this.var_1086.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_998.width,this.var_998.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_998,this.var_998.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_1086)
            {
               switch(this.var_1086.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_45:
                     _loc4_.style = HabboIconType.const_733;
                     _loc4_.visible = true;
               }
            }
            else
