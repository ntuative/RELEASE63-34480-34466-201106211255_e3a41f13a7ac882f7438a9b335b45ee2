package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private var var_1261:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_543 = param2;
         this.var_1013 = this.var_543.avatarRenderManager.getFigureData(AvatarType.const_130);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_659["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_659["null"];
         var _loc3_:FigureData = this.var_659["null"];
         _loc2_.loadAvatarData(const_1567,FigureData.const_88);
         _loc3_.loadAvatarData(const_1568,FigureData.FEMALE);
         this.var_116 = new Map();
         this.var_544 = new Map();
         this.var_116.add(AvatarEditorFigureCategory.const_933,new BodyModel(this));
         this.var_116.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
         this.var_116.add(AvatarEditorFigureCategory.const_302,new TorsoModel(this));
         this.var_116.add(AvatarEditorFigureCategory.const_932,new LegsModel(this));
         ...
         this.var_544.add(AvatarEditorSideCategory.const_107,new WardrobeModel(this));
         this.var_544.add(AvatarEditorSideCategory.const_492,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc5_:FigureData = this.var_659[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_933);
         }
      }
      ...
      {
         return this.var_659[this.var_1112];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1261.saveFigure(_loc1_,_loc2_);
         }
         else
         {
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            for each(_loc13_ in _loc9_.colors)
            {
               ...
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_700)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1677.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1390.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1390.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_544.getValue(AvatarEditorSideCategory.const_107);
      }
