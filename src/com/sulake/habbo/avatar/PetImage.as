   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1463);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_305.definition.geometryType);
         if(this.var_47 == null || _loc4_ != null && (this.var_47.width != _loc4_.width || this.var_47.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_305.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_511 = this.var_511 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function sortActions() : void
      {
         ...
         this.var_1464 = this._structure.sortActions(this.var_352);
         ...
         {
            this.var_846 = this._structure.getCanvasOffsets(this.var_1464,this._scale,this.var_101);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1464)
         {
