package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1415:String = "Default";
      
      private static const const_1417:int = 2;
      
      private static const const_1416:String = AvatarSetType.const_41;
      ...
      protected var var_305:IActiveActionData;
      ...
      private var var_2259:String = null;
      
      private var var_2260:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1416,const_1417);
         this.var_352 = new Array();
         this.var_960 = new ActiveActionData(AvatarAction.const_421);
         this.var_960.definition = this._structure.getActionDefinition(const_1415);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1125)
         {
            ...
            if(this.var_741)
            {
               for each(_loc2_ in this.var_741)
               {
                  _loc2_.dispose();
               }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param2 < AvatarDirectionAngle.const_1363)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_264.length == 1 && this.var_101 == this.var_1894)
         {
            return this.var_101 + this.var_511 + this.var_607 % 4;
         }
      ...
      {
         if(param3 != this.var_2258 || param2 != this.var_2259 || param1 != this.var_2260)
         {
            this.var_2258 = param3;
            this.var_2259 = param2;
            this.var_2260 = param1;
            this.var_1706 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_305.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1391 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1391)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_305.definition.geometryType,this.var_101);
         this.var_47.lock();
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_305.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_305.definition.geometryType,this.var_101);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_352.push(new ActiveActionData(param1,param2,this.var_607));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_305 = this.var_960;
         this.var_305.definition = this.var_960.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_511 = "";
         this.var_264 = this._structure.sortActions(this.var_352);
         if(this.var_264 == null)
         {
            this.var_846 = new Array(0,0,0);
            if(this.var_1140 != "")
            {
               _loc1_ = true;
               this.var_1140 = "";
         ...
         {
            this.var_846 = this._structure.getCanvasOffsets(this.var_264,this._scale,this.var_101);
            for each(_loc4_ in this.var_264)
            {
               this.var_511 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_355)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1418 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1418 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1140 != this.var_511)
            {
               _loc1_ = true;
               this.var_1140 = this.var_511;
            }
         }
         this.var_1419 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_264)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_959 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_350 || _loc1_.actionType == AvatarAction.const_248 || _loc1_.actionType == AvatarAction.const_415)
               {
                  this.var_959 = true;
               }
            }
