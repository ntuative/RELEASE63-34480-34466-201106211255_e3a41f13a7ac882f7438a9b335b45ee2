package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2998:uint;
      
      private var var_2999:uint;
      ...
      private var var_2162:Number = 1.0;
      
      private var var_2163:Number = 1.0;
      
      private var var_2161:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1386:Map;
      
      private var var_3000:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2998 = parseInt(_loc2_,16);
         this.var_2999 = parseInt(_loc3_,16);
         ...
         this.var_835 = new ColorTransform(this.var_2162,this.var_2163,this.var_2161,this._alphaMultiplier);
         this.var_1386 = this.generatePaletteMapForGrayscale(this.var_2999,this.var_2998);
      }
      ...
      {
         return this.var_1386.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1386.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1386.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1386.getValue("alphas") as Array;
      }
