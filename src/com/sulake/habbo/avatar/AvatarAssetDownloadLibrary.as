package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1765:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1180 = param3 + this.var_755 + ".swf";
         this.var_1180 = this.var_1180.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1765;
         var _loc1_:URLRequest = new URLRequest(this.var_1180);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_755 + " from URL " + this.var_1180,false,Core.const_1210);
      }
