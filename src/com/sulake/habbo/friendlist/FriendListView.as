package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1868:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1868 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1461;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_963 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_281 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1868.prepare(this.var_963);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1266,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1248,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_925,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_882,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_925,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_882,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1518 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1518.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1866 == -1 ? 0 : int(this.var_17.height - this.var_1866);
         var _loc4_:int = this.var_1865 == -1 ? 0 : int(this.var_17.width - this.var_1865);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_281.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1166,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_925,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1266,false);
         ...
         this.var_1866 = this.var_17.height;
         this.var_1865 = this.var_17.width;
