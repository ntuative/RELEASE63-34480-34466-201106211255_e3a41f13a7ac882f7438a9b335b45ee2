package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2135:String = "bg";
      ...
      private var var_2525:IContainerButtonWindow;
      ...
      {
         this.var_2526 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2525 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2526,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2525,this.isEnableHomeButton(_loc1_));
