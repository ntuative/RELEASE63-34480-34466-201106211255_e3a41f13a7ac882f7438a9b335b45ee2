package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2142:int = "F".charCodeAt(0);
      
      public static const const_2213:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1112 = param1.gender;
         this.var_830 = param1.online;
         this.var_1777 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1806 = param1.motto;
         this.var_1805 = param1.lastAccess;
         this.var_1635 = param1.categoryId;
