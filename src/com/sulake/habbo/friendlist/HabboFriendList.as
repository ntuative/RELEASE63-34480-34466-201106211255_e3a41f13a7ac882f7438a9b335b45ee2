package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_148:IHabboMessenger;
      ...
      private var var_763:ISessionDataManager;
      
      private var var_2455:FriendListLookAndFeel;
      ...
      {
         this.var_2455 = new FriendListLookAndFeel();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_148)
         {
            this.var_148.release(new IIDHabboMessenger());
            this.var_148 = null;
         }
         if(this.var_178)
         {
         ...
         if(this.var_763)
         {
            this.var_763.release(new IIDSessionDataManager());
            this.var_763 = null;
         }
         super.dispose();
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_402);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_334,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_743.createAvatarImage(param1,AvatarScaleType.const_115,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_148 = param2 as IHabboMessenger;
      ...
      {
         this.var_763 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_116.addCategory(new FriendCategory(FriendCategory.const_1364,this.getText("friendlist.friends")));
         this.var_116.addCategory(new FriendCategory(FriendCategory.const_419,this.getText("friendlist.friends.offlinecaption")));
         ...
         {
            _loc5_ = this.var_116.findCategory(FriendCategory.const_419);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_434.findTab(FriendListTab.const_93).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_434.findTab(FriendListTab.const_93);
      ...
      {
         var _loc2_:FriendListTab = this.var_434.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_434.findTab(FriendListTab.const_93);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_763 || !this.var_118)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_763.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_118.vipLimit;
         }
         else if(this.var_763.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
