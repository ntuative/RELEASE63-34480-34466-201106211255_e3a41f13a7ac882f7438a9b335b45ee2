package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_341:MainViewCtrl;
      
      private var var_715:RoomInfoViewCtrl;
      
      private var var_1348:RoomCreateViewCtrl;
      ...
      private var var_2707:RoomThumbnailRenderer;
      
      private var var_939:GuestRoomPasswordInput;
      
      private var var_316:GuestRoomDoorbell;
      
      private var var_1349:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_341 = new MainViewCtrl(this);
         this.var_715 = new RoomInfoViewCtrl(this);
         this.var_1348 = new RoomCreateViewCtrl(this);
         this.var_2707 = new RoomThumbnailRenderer(this);
         this.var_939 = new GuestRoomPasswordInput(this);
         this.var_316 = new GuestRoomDoorbell(this);
         this.var_434 = new Tabs(this);
         this.var_1349 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_334,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_341.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_341.startSearch(Tabs.const_212,Tabs.const_437,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_341.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_341.startSearch(Tabs.const_301,Tabs.const_244);
         this.var_434.getTab(Tabs.const_301).tabPageDecorator.tabSelected();
      }
