package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_412);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_729);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_412,"" + _loc3_);
         }
         if(this.var_152)
         {
