package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_587:RoomPopupCtrl;
      
      private var var_600:IScrollbarWindow;
      
      private var var_1188:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_587 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1188 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_600 = IScrollbarWindow(this.var_205.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_205.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1776,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this.var_1188.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_587.visible && this.var_2971)
         {
            return;
         }
         ...
         this.var_587.room = _loc4_;
         this.var_587.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1665.tags[0];
            this.var_1665.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2972 - _loc2_.stageX);
         this.var_2972 = _loc2_.stageX;
