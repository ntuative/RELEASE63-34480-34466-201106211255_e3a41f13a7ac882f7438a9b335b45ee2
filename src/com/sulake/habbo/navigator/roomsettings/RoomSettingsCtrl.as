package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_941:TextFieldManager;
      ...
      private var var_753:ICheckBoxWindow;
      
      private var var_1749:ITextWindow;
      
      private var var_942:IDropMenuWindow;
      ...
      {
         if(param1 != this.var_361 || this.var_1174 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1950)
         {
            this.var_751.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1917)
         {
            this.var_1170.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1747)
         {
            this.setTagError(this.var_941,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_943,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1758)
         {
            this.setTagError(this.var_941,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_939.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_356,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_603,this.onDoorModePasswordUnselect);
         ...
         this.var_941 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_943 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_939 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1167 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1172 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         ...
         this.var_753 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1749 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_942 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_940 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2375 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1171 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1169 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1751 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1444 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_1443 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1443.mouseThreshold = 0;
         this.var_1443.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1168.visible = false;
         if(!this.var_1445)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1751.visible = this.var_1445;
         this.populateForm();
         if(this.var_752)
         {
            this.var_1169.visible = true;
            this.var_1444.visible = true;
            this.refreshFlatControllers();
            this.var_1169.height = Util.getLowestPoint(this.var_1169) + 4;
         }
         else
         {
            this.var_1171.visible = true;
            this.var_1444.visible = true;
            this.var_2375.visible = this.var_1445;
            this.var_1171.height = Util.getLowestPoint(this.var_1171) + 4;
         }
         this.var_1443.text = !!this.var_752 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1171.name,this.var_1169.name,this.var_1444.name,this.var_1751.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_939.setText("");
         this.var_1167.setText("");
         ...
         this.setTag(this.var_941,_loc1_.tags[0]);
         this.setTag(this.var_943,_loc1_.tags[1]);
         if(this.var_1172)
         {
            if(_loc1_.allowPets)
            {
               this.var_1172.select();
            }
            else
            {
               this.var_1172.unselect();
            }
         }
         if(this.var_1175)
         {
         ...
         {
            this.disableWindow(this.var_753);
            this.disableWindow(this.var_942);
            this.disableWindow(this.var_940);
            this.disableWindow(this.var_1749);
         }
         else
         {
            this.enableWindow(this.var_753);
            this.enableWindow(this.var_942);
            this.enableWindow(this.var_940);
            this.enableWindow(this.var_1749);
         }
         if(this.var_753)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_753.unselect();
            }
         }
         if(this.var_942)
         {
            this.var_942.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_940)
         {
            this.var_940.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_585;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_133)
         {
            _loc8_ = this.var_939.getText();
            _loc9_ = this.var_1167.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_939.clearErrors();
         ...
         _loc2_.allowPets = this.var_1172.isSelected;
         _loc2_.allowFoodConsume = this.var_1175.isSelected;
         _loc2_.allowWalkThrough = this.var_1173.isSelected;
         _loc2_.hideWalls = this.var_753.isSelected;
         _loc2_.wallThickness = this.var_942.selection - 2;
         _loc2_.floorThickness = this.var_940.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_941,_loc2_.tags);
         this.addTag(this.var_943,_loc2_.tags);
         this.clearErrors();
         this.var_1174 = _loc2_.roomId;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_74,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
