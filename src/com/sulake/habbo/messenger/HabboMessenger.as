package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_456:Conversations;
      
      private var var_198:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_178 && this._localization && this._friendList && this.var_743 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_456 = new Conversations(new ConversationsDeps(this));
         this.var_198 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_456.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_456.setSelected(_loc2_);
            this.var_198.openMessenger();
            this.var_198.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_456 ? this.var_456.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_456.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_456.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_198 && this.var_198.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_198)
         {
            if(this.var_198.isMessengerOpen())
            {
               this.var_198.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_877,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1267,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_456.addMessageAndUpdateView(param1);
         if(!this.var_198.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1354);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_456.addMessageAndUpdateView(_loc3_);
      }
