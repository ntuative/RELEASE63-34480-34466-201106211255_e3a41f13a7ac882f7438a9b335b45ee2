package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1487:String = "sendAccessTokenToServer";
      
      private static const const_1488:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1487,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1488,this.jsFaceBookLogOutCallback);
