package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2332:int = 2500;
      ...
      private var var_1288:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1288 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1288.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1580));
         this.var_1581.add(this.var_1580,getTimer());
         ++this.var_1580;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1581.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2332)
            {
      ...
      {
         return this.var_1288 as IUserDataManager;
      }
