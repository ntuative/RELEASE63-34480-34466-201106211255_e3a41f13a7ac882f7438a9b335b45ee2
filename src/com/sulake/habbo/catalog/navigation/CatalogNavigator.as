package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3083:String = "magic.credits";
      
      private var var_3044:String = "magic.pixels";
      
      private var var_3045:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3044);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3045,true);
      }
