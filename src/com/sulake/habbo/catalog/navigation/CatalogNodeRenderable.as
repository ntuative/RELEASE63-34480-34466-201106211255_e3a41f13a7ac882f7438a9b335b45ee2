package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1583:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1562:XML;
      
      private static var var_1561:XML;
       
      
      private var var_1958:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3046:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1958 == 4294967295)
            {
               this.var_1958 = _loc1_.color;
            }
            _loc1_.color = const_1583;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1961;
            }
         }
      }
      ...
      {
         this.var_62 = navigator.catalog.windowManager.buildFromXML(var_1561) as IItemListWindow;
         if(this.var_62 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1562) as IWindowContainer;
         }
         else
         {
