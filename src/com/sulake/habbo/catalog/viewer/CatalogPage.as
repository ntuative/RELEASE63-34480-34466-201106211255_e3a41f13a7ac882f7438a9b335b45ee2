package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2039:String = "ctlg_";
       
      
      protected var var_2232:XML;
      ...
      private var var_1256:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1255);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1255);
      }
      ...
      {
         var _loc2_:String = const_2039 + param1;
         ...
         this.var_2232 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2232) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1834:
               if(this.var_1256 == null)
               {
                  this.var_1256 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_40.push(this.var_1256);
               }
               break;
