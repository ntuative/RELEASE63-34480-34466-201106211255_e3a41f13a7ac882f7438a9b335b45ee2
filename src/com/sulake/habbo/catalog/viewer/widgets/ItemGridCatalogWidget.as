package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_509:IItemGridWindow;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_744,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_312,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_832,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_282,this.deActivateScrollbar);
         }
         this.var_34 = param2;
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_509 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_896 >= 0 && this.var_896 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_896];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2107) as IWindowContainer;
         this.var_509.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_487)
         {
            ++this.var_2146;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2146);
         }
      }
