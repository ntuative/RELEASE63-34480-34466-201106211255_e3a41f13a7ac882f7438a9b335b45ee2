package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1267:ITextWindow;
      
      private var var_97:IBitmapWrapperWindow;
      
      private var var_201:IWindowContainer;
      
      private var var_548:IDisplayObjectWrapper;
      
      private var var_1944:Point;
      
      private var var_547:IItemGridWindow;
      
      private var var_1556:IScrollbarWindow;
      
      protected var var_2107:XML;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_201.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_201 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1267 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_97 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_201 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_201 != null)
         {
            this.var_201.visible = false;
            this.var_548 = this.var_201.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_548 != null && _loc3_ != null)
            {
               this.var_201.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_548.width,this.var_548.height);
               if(_loc4_ != null)
               {
                  this.var_548.setDisplayObject(_loc4_);
               }
            }
            else
            {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1267.text = _loc5_;
         this.var_1017.height = this.var_1017.textHeight + 5;
         this.var_1267.y = this.var_1017.y + this.var_1017.height;
         this.var_1267.height = Math.max(130,this.var_1267.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_487:
                  ...
                  if(this.var_547 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_547,this.var_1556,this.var_2107);
               ...
               case Offer.const_410:
                  ...
                  if(this.var_201 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_73 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_181)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_73:
                        if(_loc8_ != null && this.var_548 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_378,AvatarAction.const_562);
                                 _loc18_.appendAction(AvatarAction.const_355,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2673)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2673 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1944.x;
            this.var_97.y = this.var_1944.y;
            if(param3 != null)
            {
