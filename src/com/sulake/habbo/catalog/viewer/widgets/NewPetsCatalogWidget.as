package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1561:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2609 = _loc2_.localizationId;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_228 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1561 && _loc2_ < this.var_228.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_537,this.var_228[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_537,this.var_376),this.getRaceLocalizationKey(this.var_537,this.var_376));
            }
         }
         return this.getRaceLocalizationKey(this.var_537,this.var_376);
      }
