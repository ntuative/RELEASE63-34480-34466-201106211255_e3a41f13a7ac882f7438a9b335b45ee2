package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2609 = _loc3_.localizationId;
         this.var_405 = [];
         if(page && false && page.viewer.catalog)
         {
         ...
         events.addEventListener(WidgetEvent.const_847,this.onApproveNameResult);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_575 = param1.index;
         if(this.var_575 < 0 || this.var_575 > this.var_405.length)
         {
            this.var_575 = 0;
         }
         this.updateImage();
      ...
      {
         if(param1.productCode == this.var_2609)
         {
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_228 == null || this.var_876 >= this.var_228.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_575 >= 0 && this.var_575 < this.var_405.length)
         {
            _loc7_ = this.var_405[this.var_575] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_228[this.var_876] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_537,_loc3_,_loc2_,AvatarScaleType.const_60,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_378,AvatarAction.const_871);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_575 >= this.var_405.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_405[this.var_575] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_228[this.var_876] as int;
