package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_215[this.var_530][this.var_650];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_530 = var_509.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_530];
         var _loc3_:Array = this.var_215[this.var_530] as Array;
      ...
      {
         var _loc2_:Array = this.var_215[this.var_530] as Array;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_215[this.var_530] as Array;
