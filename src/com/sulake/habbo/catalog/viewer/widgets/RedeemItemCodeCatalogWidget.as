package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_972.removeEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
            this.var_972 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_972 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_972 != null)
         {
            this.var_972.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         }
         return true;
      }
