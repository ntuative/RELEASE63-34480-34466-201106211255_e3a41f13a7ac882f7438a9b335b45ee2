package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1586:int = 16763904;
      
      private static const const_1587:int = 13421772;
      
      private static const const_1585:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_286.getWithIndex(this.var_325);
         if(_loc4_ != null)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_286.getWithIndex(this.var_325);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_325;
         if(this.var_325 >= this.var_286.length)
         {
            this.var_325 = 0;
         }
         var _loc2_:Map = this.var_286.getWithIndex(this.var_325);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_325 < 0)
         {
            this.var_325 = this.var_286.length - 1;
         }
         var _loc2_:Map = this.var_286.getWithIndex(this.var_325);
         if(_loc2_ != null)
         {
