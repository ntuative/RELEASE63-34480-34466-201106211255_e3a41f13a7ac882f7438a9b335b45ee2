package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_1549:int = 64;
      
      private static const const_1550:int = 32;
      
      private static const const_1548:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_916,this.onRoomObjectAdded);
      ...
      public function dispose() : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_916,this.onRoomObjectAdded);
      ...
      public function reset() : void
      {
         if(this._roomEngine != null)
         {
            ...
            this._roomEngine.method_6(const_53,const_54,const_66);
         }
         this.var_319 = RoomObjectCategoryEnum.const_140;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_319 == RoomObjectCategoryEnum.const_27 && this.var_1232 == param1)
            {
               return const_66;
            }
            this.reset();
            this.var_1232 = param1;
            this.var_319 = RoomObjectCategoryEnum.const_27;
            this.var_1519 = "";
            if(this._roomEngine.addObjectFurniture(const_53,const_54,const_66,param1,new Vector3d(const_693,const_694,0),param2,0,""))
            {
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_319 == RoomObjectCategoryEnum.const_26 && this.var_1232 == param1 && this.var_1519 == param3)
            {
               return const_66;
            }
            this.reset();
            this.var_1232 = param1;
            this.var_319 = RoomObjectCategoryEnum.const_26;
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            this.reset();
            this.var_1232 = 1;
            this.var_319 = RoomObjectCategoryEnum.const_29;
            this.var_1519 = param1;
            if(this._roomEngine.addObjectUser(const_53,const_54,const_66,new Vector3d(const_693,const_694,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1234 = getTimer();
               this.var_1233 = true;
      ...
      public function changeRoomObjectState() : void
      {
         ...
         {
            this.var_1233 = false;
            if(this.var_319 != RoomObjectCategoryEnum.const_29)
            {
               this._roomEngine.changeObjectState(const_53,const_54,const_66,this.var_319);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1234 + const_1548)
            {
               this.var_1234 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_53,const_54,const_66,this.var_319);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_53,const_54,const_237,param1,param2,this.var_1231);
            ...
            if(_loc4_ != null)
            {
               _loc4_.adjustLocation(new Vector3d(const_693,const_694,0),30);
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_53,const_54,const_66,this.var_319,const_237);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1230 >> 1),-(this.var_991 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_49.width > this.var_1230 - this.var_49.width >> 1 || _loc3_.height - this.var_49.height > this.var_991 - this.var_49.height >> 1 || this.var_49.width < 1 || this.var_49.height < 1)
               {
                  this.var_49 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         if(this.var_49.width > this.var_1230 * (1 + const_474) || this.var_49.height > this.var_991 * (1 + const_474))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1231 = const_1550;
               this.var_1872 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_49.left >>= 2;
         ...
         else if(this.var_49.width << 1 < this.var_1230 * (1 + const_474) - 5 && this.var_49.height << 1 < this.var_991 * (1 + const_474) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_1872)
            {
               _loc2_.performZoomIn();
               this.var_1231 = const_1549;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_991 - this.var_49.height >> 1;
         if(_loc4_ > 10)
         {
            _loc3_ += Math.min(15,_loc4_ - 10);
         }
         else if(this.var_319 != RoomObjectCategoryEnum.const_29)
         {
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_53 && param1.roomCategory == const_54 && param1.objectId == const_66 && param1.category == this.var_319)
         {
            this.var_49 = null;
            this.var_1872 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_645);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_769);
