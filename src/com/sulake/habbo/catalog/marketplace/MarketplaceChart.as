package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_684)
            {
               this.var_684 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_684).toString().length - 1);
         this.var_684 = Math.ceil(this.var_684 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_684.toString();
         _loc3_.draw(_loc6_);
         this.var_1321 = param1 - _loc6_.textWidth - 2;
         this.var_1075 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_1075);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_1075 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1321,(param2 - this.var_1075) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1321 + this.var_1321 / -this.var_3050 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_1075 - this.var_1075 / this.var_684 * this.var_174[param1];
      }
