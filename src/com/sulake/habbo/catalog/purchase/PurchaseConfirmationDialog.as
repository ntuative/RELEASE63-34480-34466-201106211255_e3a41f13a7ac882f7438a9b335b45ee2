package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2324:int = 10;
      ...
      private const const_2059:uint = 4.293848814E9;
      
      private const const_2060:uint = 4.294967295E9;
      
      private const const_1518:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_351,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_379,this.onMessageInputFocus);
         }
         this.var_1928 = true;
         this.var_1927 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_356,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_513,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_807 = _loc1_.boxTypes;
            this.var_809 = _loc1_.ribbonTypes;
            this.var_1264 = this.var_1747[0];
            this.var_381 = this.var_807[0];
            this.var_380 = this.var_809[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_380 < 0)
         {
            this.var_380 = this.var_809.length - 1;
         }
         if(this.var_380 > this.var_809.length - 1)
         {
            this.var_380 = 0;
         }
         if(this.var_381 < 0)
         {
            this.var_381 = this.var_807.length - 1;
         }
         if(this.var_381 > this.var_807.length - 1)
         {
            this.var_381 = 0;
         }
         var _loc1_:int = this.var_807[this.var_381] * 1000 + this.var_809[this.var_380];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1264,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1550 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1747)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_807[this.var_381]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_809[this.var_380]);
         this._catalog.purchaseProductAsGift(this.var_1552,this.var_1263,this.var_1551,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1552,this.var_1263,this.var_1551);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_238)
         {
            ...
            if(_loc4_.length >= this.const_2324)
            {
               break;
            }
         }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_379 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_379 + 1);
               break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_379) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_808 == null)
         {
            this.var_808 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_282 == null || this.var_808 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_808.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_379) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_379);
         }
         this.var_379 = param1;
         if(this.var_379 < 0)
         {
            this.var_379 = _loc2_.numListItems - 1;
         }
         if(this.var_379 >= _loc2_.numListItems)
         {
            this.var_379 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_379) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1518;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2059) : uint(this.const_2060);
      }
      ...
      {
         this.var_1264 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
