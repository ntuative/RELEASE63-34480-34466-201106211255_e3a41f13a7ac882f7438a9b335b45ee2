package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_695:uint = 1;
      ...
      private var var_1181:IRoomSession;
      ...
      private var var_150:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_197:PurchaseConfirmationDialog;
      
      private var var_217:ChargeConfirmationDialog;
      ...
      private var var_2570:Boolean = true;
      
      private var var_2572:Boolean = true;
      
      private var var_1879:Boolean = false;
      
      private var var_2569:GiftWrappingConfiguration;
      
      private var var_1240:ClubGiftController;
      ...
      private var var_789:IPurchasableOffer;
      
      private var var_1522:IDragAndDropDoneReceiver;
      ...
      private var var_653:RoomPreviewer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_81,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1786);
               return;
            }
      ...
      {
         if(this._roomEngine != null && this.var_178 != null && this.var_178.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_653 == null)
            {
               this.var_653 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_178.getKey("toolbar.new_additions.notification.enabled","false") == "true";
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_695) as IWindowContainer;
         ...
         _loc3_.setParamFlag(WindowParam.const_275,false);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_150 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1240 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1523 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_320.buildCatalogIndex(_loc2_);
         if(this.var_787 && this.var_787 != "")
         {
            this.var_320.openPage(this.var_787);
            this.var_787 = "";
            this.var_995 = -1;
         }
         else if(this.var_995 > -1)
         {
            this.var_320.openPageById(this.var_995,this.var_1878);
            this.var_995 = -1;
            this.var_1878 = -1;
            this.var_787 = "";
         }
         else if(this.var_1523 && this.var_2571)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_320.method_12(this.getLocalizedPageName(CatalogPageName.const_1993));
         }
         else
         {
            this.var_320.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2570 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1222);
         }
         this.var_2570 = false;
         if(this.var_217 != null && !this.var_217.disposed)
         {
            this.var_217.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_108,this.var_111.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2572 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1378);
         }
         this.var_2572 = false;
         if(this.var_217 != null && !this.var_217.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_250,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_931)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_257,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_250,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_257,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_111.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1246 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1240.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_150 != null)
         {
            this.var_150.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_150 != null)
         {
            this.var_150.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_150 != null)
         {
            this.var_150.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2569 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_150.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_217 == null || this.var_217.disposed)
         {
            this.var_217 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_217.showChargeInfo(_loc2_);
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1181 || !this.var_1181.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1239 && param1.type == RoomEngineObjectEvent.const_171)
         {
            this.resetPlacedOfferData(true);
            if(this.var_789 == null || this.var_789.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_789.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_789);
            _loc5_ = this.var_1522;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_372,0.5);
            }
         }
      }
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_695);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_653 != null)
         {
            this.var_653.updatePreviewRoomView();
         }
      }
   }
}
