package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_618 != const_1040;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1761 != RecyclerStatusMessageEvent.const_1207;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_618 == const_466;
      }
      ...
      {
         this.var_618 = const_1039;
         this.var_125 = new Array(const_209);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1761)
         {
            case RecyclerStatusMessageEvent.const_2021:
               this.var_618 = const_466;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1207:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1762:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1323:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1886:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_125.length < const_209)
         {
            return false;
         }
         var _loc1_:int = 0;
