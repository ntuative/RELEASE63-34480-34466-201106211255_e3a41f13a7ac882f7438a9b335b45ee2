package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1967:String = "sample_44khz";
      
      public static const const_1909:String = "sample_22khz";
      
      public static const const_1760:String = "sample_11khz";
      
      public static const const_1755:String = "sample_16bit";
      
      public static const const_1955:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1138:int = 32;
      ...
      private var var_139:Vector.<int> = null;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_186 * this.var_86;
         var _loc7_:int = param1.length / 8;
         _loc7_ = int(_loc7_ / _loc6_) * _loc6_;
         this.var_139 = new Vector.<int>(_loc7_ / _loc6_,true);
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1138)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1138);
            }
            ...
            {
               this.var_139[int(_loc11_ / this.var_186)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_139.length * this.var_186 * this.var_86;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_139 == null)
         {
            return param4;
         }
         var _loc5_:int = this.var_186 * this.var_86;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_139.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_139.length - param4)) * _loc5_;
            _loc6_ = this.var_139.length - param4;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_711.indexOf(param1) == -1)
         {
