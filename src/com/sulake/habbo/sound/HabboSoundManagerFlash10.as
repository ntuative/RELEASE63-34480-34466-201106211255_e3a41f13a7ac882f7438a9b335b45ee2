package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1491:int = 16777215;
      ...
      private var var_968:Number = 1.0;
      ...
      private var var_1482:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_748,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_969.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1168:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1935:
            ...
            this.var_969.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_968;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_633.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1199.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_272,events);
         _loc5_.volume = this.var_968;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_272.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_970.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_970 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_178 == null || this._connection == null || this._roomEngine == null || this.var_253 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1821,this.var_765));
         this.var_765 = -1;
         this.var_766 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_968 * 100)));
         }
      }
      ...
      {
         this.var_968 = param1;
         this.var_253.updateVolume(this.var_968);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_633.getValue(param1) != null)
         {
            _loc2_ = this.var_633.remove(param1);
            if(this.var_272.getValue(_loc2_) == null)
            {
               this.var_1482.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1482,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1482,_loc2_,TraxSample.const_1967,TraxSample.const_1755);
               this.var_272.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1200.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1492 && this.var_1200.length > 0)
            {
               _loc3_ = this.var_1200.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_633.length == 0 && this.var_765 != -1)
            {
               this.var_766.ready = true;
               _loc4_ = this.var_765;
               this.var_765 = -1;
               this.var_766 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_748,_loc4_));
               if(this.var_2472)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_766 == null && this.var_1199.length > 0)
         {
            _loc1_ = this.var_1199.getKey(0);
            _loc2_ = this.var_1199.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_748,_loc1_));
               }
               else
               {
                  this.var_766 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_272.getKey(_loc4_);
            _loc6_ = this.var_272.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1493)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1491 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_272.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_272.remove(_loc11_);
               }
