package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_942,this.onSoundMachinePlayEvent);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_825,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_942,this.onSoundMachinePlayEvent);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_825,this.onSoundMachineStopEvent);
               this.var_92 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_485 = -1;
         this.var_689 = false;
         this.var_253.stop(HabboMusicPrioritiesEnum.const_134);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_253.playSong(param1,HabboMusicPrioritiesEnum.const_134,_loc3_,0,0,0))
         {
