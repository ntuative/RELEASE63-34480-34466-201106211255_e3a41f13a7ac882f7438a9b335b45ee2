package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1661:int = HabboMusicPrioritiesEnum.const_134;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_797,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_240,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_948,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_756,this.onSoundMachineDispose);
         this.var_1338 = new Timer(1000);
         this.var_1338.start();
         this.var_1338.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         if(this.getSongIdPlayingAtPriority(this._priorityPlaying) == param1.id)
         {
            ...
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_439)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_121,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_297)
            {
               ...
               {
                  _loc3_ = this.var_297.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_797,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_240,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_948,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_756,this.onSoundMachineDispose);
            }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_297.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_297.length)
         {
            ...
            if(_loc3_.id != this.var_1628 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         while(_loc2_ < this.var_338.length)
         {
            if(this.var_338[_loc2_] != null)
            {
               ...
               _loc4_ = this.var_297.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_867));
         Logger.log("Requested song info\'s : " + this.var_867);
         this.var_867 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_297.add(_loc6_.id,_loc10_);
               ...
               while(this.var_868.indexOf(_loc6_.id) != -1)
               {
                  this.var_868.splice(this.var_868.indexOf(_loc6_.id),1);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         if(this._priorityPlaying <= const_1661)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_134)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_132,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2897 != param1.id || _loc3_ > this.var_2896 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2897 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_569 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
