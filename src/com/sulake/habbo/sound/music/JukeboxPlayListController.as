package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_253.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_134,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_2092 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_105,HabboMusicPrioritiesEnum.const_134,_loc3_.currentSongId,_loc3_.currentPosition));
      }
