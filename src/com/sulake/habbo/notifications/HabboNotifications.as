package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1688:String = "pixelbalance";
      
      private static const const_1686:String = "badges";
      
      private static const const_1691:String = "selectbadge";
      
      private static const const_1684:String = "inventory";
      
      private static const const_1685:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1689:String = "friendlist";
      
      private static const const_1690:String = "pet_inventory";
      
      private static const const_1687:String = "go_to_room";
      ...
      private var var_886:ParkBusDialogManager;
      
      private var var_2947:Boolean;
      
      private var var_1102:ClubGiftNotification;
      
      private var var_1104:ClubEndingNotification;
      
      private var var_1103:ClubPromoNotification;
      
      private var var_3061:Dictionary;
      ...
      {
         var _loc1_:Array = this.var_1358.splice(0,1);
      ...
      public function setQuestTrackerHeight(param1:int) : void
      {
         if(this.var_410)
         {
            this.var_410.topMarginIncrease = param1;
         }
      }
      ...
      {
         this.var_410 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1105["styles"],this.var_1105["view"]);
         ...
         registerUpdateReceiver(this.var_410,1);
         registerUpdateReceiver(this,2);
         this.var_371.events.addEventListener(BadgeImageReadyEvent.const_221,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_371.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1350,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1350,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2002,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_944,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_1099.createAvatarImage(param2,AvatarScaleType.const_60);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1964,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1323)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1104 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1103 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_410.isSpaceAvailable() && this.var_1358.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_410.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_410.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_886 == null)
         {
            this.var_886 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_886 != null)
         {
            this.var_886.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1099.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_60);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2947)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_944,null);
            this.var_2947 = true;
      ...
      {
         if(param2.type == WindowEvent.const_176 || param2.type == WindowEvent.const_536)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1102 && this.var_1102.visible)
         {
            return;
         }
         this.var_1102 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_944,_loc6_);
      }
   }
}
