package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_617:int = 70;
      
      public static const const_1895:int = 4;
      
      private static const name_4:int = 0;
      
      private static const const_646:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2042 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2042 = 15;
         }
         this.var_2044 = this._window.height;
         this.var_1611 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_646:
               ...
               _loc2_ = Number(this.var_1318) / Number(this.var_1073["time_fade_in"]);
               if(this.var_1318 > int(this.var_1073["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1128:
               ...
               if(this.var_1610 > int(this.var_1073["time_display"]) && !this.var_2043)
               {
                  this.startFadeOut();
               }
               break;
            case const_1129:
               ...
               _loc3_ = 1 - Number(this.var_1319) / Number(this.var_1073["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1319 > int(this.var_1073["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2042;
         if(this._window.height < this.var_2044)
         {
            this._window.height = this.var_2044;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1895;
