package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1053:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_968 = param1.volume;
         if(this.var_1053 != null)
         {
            this.var_1053.setValue(this.var_968);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1052 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1054 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1053 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_758));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_968 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1054);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1052);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1056);
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_920);
         }
         else
         {
