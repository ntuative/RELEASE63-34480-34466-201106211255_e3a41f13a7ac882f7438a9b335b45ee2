package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_2318:int = 4;
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_686:
               ...
               this._view.findChildByName("edit_text").visible = this.var_978;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_978);
               break;
            ...
            case this.const_1506:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_978);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_866,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1208 ? this.const_1065 : this.const_686);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1494 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1494));
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_611:
               ...
               this.var_1208 = param1.isVerified;
               this.var_978 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1495 = this.var_1494;
            this.setViewState(this.const_686);
         }
         else
         {
            if(param1.result == this.const_2318)
            {
               this.var_978 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1494);
