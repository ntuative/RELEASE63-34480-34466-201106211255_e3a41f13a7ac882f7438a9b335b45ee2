package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1483:int = 14;
      
      private static const const_1485:int = 500;
      ...
      protected var var_1399:String;
      
      protected var _text:String;
      
      protected var var_353:String;
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1399 = param1.objectType;
         this._text = param1.text;
         this.var_353 = param1.colorHex;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2221,"",HabboWindowType.const_74,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1484,const_1482,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_353);
            }
         ...
         this.setColorButtons(this.var_27 && this.var_1399 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_642,this.var_234,this._text,this.var_353);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_642,this.var_234,this._text,this.var_353);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_784,this.var_234);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1485;
         if(_loc2_.numLines < const_1483)
         {
            return;
         }
