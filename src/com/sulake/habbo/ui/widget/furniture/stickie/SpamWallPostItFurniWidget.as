package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_533,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_533,this.onEditPostItRequest);
      }
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_450 = param1.location;
         var_1399 = param1.objectType;
         _text = "";
         var_353 = "FFFF33";
         var_27 = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_234 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_875,var_234,this.var_450,_text,var_353);
