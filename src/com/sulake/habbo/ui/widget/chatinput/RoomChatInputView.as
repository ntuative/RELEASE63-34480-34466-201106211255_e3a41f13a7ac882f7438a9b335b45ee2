package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1611:int = 250;
      
      private static const const_1613:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1612:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1296 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2748 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2749 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_391 = new Timer(1000,1);
         this.var_391.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_391.reset();
            this.var_391.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_391 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2004 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2005 = this._window.findChildByName("send_button_text");
         this.var_1589 = this._window.findChildByName("block_text");
         this.var_2005.caption = const_1612;
         this.var_28.setParamFlag(HabboWindowParam.const_44,true);
         ...
         this.var_28.addEventListener(WindowKeyboardEvent.const_351,this.keyUpHandler);
         this.var_28.addEventListener(WindowEvent.const_109,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_545,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2004.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1611 - _loc3_;
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_28 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1296 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_28.text = "";
                  this.var_674 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_674.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_673);
