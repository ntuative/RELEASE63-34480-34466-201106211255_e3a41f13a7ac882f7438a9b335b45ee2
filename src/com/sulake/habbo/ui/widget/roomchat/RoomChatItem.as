package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_1524 || !var_1527 || !var_1526 || !var_1242)
         {
            var_1524 = this.buildBubbleWindow("bubble_speak");
            var_1527 = this.buildBubbleWindow("bubble_shout");
            var_1526 = this.buildBubbleWindow("bubble_whisper");
            var_1242 = this.buildBubbleWindow("bubble_whisper");
         }
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         this.var_1241 = param1.userId;
         this.var_996 = param1.userName;
         this.var_1243 = param1.userCategory;
         this._message = param1.text;
         this.var_372 = param1.links;
         this.var_1880 = param1.userX;
         this.var_280 = param1.userImage;
         this.var_2573 = param1.userColor;
      ...
      public function set y(param1:Number) : void
      {
         ...
         if(this._window != null)
         {
            this._window.y = param1 - this.var_790;
         }
      }
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_174,this.width,const_1082);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1525)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_320:
               this._window = var_1242.clone() as IRegionWindow;
               isRespect = true;
               break;
         ...
         var textWindow:ITextWindow = this._window.findChildByName(const_1081) as ITextWindow;
         ...
         if(this.var_280 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_790 = Math.max(0,(this.var_280.height - background.height) / 2);
         ...
         if(nameWindow != null)
         {
            if(!isRespect)
            {
               nameWindow.text = this.var_996 + ": ";
               nameWindow.y += this.var_790;
         ...
         if(this.var_1525 == RoomWidgetChatUpdateEvent.const_320)
         {
            textWindow.text = this.var_73.registerParameter("widgets.chatbubble.respect","username",this.var_996);
            this.var_279 = const_1080;
         }
         else if(this.var_1525 == RoomWidgetChatUpdateEvent.const_352)
         {
            textWindow.text = this.var_73.registerParameter("widget.chatbubble.petrespect","petname",this.var_996);
            this.var_279 = const_1080;
         }
         else if(this.var_372 == null)
         {
         ...
         else
         {
            ...
            lastLinkEndPos = -1;
            i = 0;
            while(i < this.var_372.length)
            {
               filteredLink = this.var_372[i][1];
               placeHolder = "{" + i + "}";
         ...
         if(textWindow.visible)
         {
            ...
            textWindow.y += this.var_790;
            messageWidth = textWindow.textWidth;
            textWindow.width = messageWidth + const_1551;
         ...
         if(pointerWindow != null && pointerWindow.visible)
         {
            ...
            pointerWindow.y += this.var_790;
         }
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2573,isRespect);
         this._window.width = bitmap.width;
         this._window.y -= this.var_790;
         this.var_279 = this._window.width;
         background.bitmap = bitmap;
         background.y = this.var_790;
      }
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:ITextWindow = this._window.getChildByName(const_1081) as ITextWindow;
         ...
         if(_loc4_ > -1)
         {
            ...
            while(_loc5_ < this.var_791.length)
            {
               ...
               {
                  if(this.var_372[_loc5_][2] == 0)
                  {
                     HabboWebTools.openExternalLinkWarning(this.var_372[_loc5_][0]);
                  }
                  else if(this.var_372[_loc5_][2] == 1)
                  {
                     HabboWebTools.openWebPage(this.var_1882 + this.var_372[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1882 + this.var_372[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      {
         if(this.var_372 && this.var_372.length > 0)
         {
         ...
         this._widget.onItemMouseClick(this.var_1241,this.var_996,this.var_1243,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1241,this.var_1243,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1241,this.var_1243,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1241,this.var_1243,this._roomId,this._roomCategory,param1);
      }
