package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_687:int = 25;
      
      private static const const_1515:int = 25;
      ...
      private static const const_688:int = 8;
      
      private static const const_469:int = 0;
      
      private static const const_1068:int = (const_688 + const_469) * const_117 + const_117;
      
      private static const const_468:int = 9;
      ...
      private var var_2517:int = 150;
      
      private var var_244:int = 171.0;
      
      private var var_984:int = 18;
      
      private var var_3035:int = 100;
      ...
      public function RoomChatWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:int, param7:Component, param8:IHabboQuestEngine)
      {
         ...
         this.var_42 = param2.createWindow("chat_container","",HabboWindowType.const_74,HabboWindowStyle.const_30,HabboWindowParam.const_47,new Rectangle(0,0,200,this.var_244 + RoomChatHistoryPulldown.const_86),null,0) as IWindowContainer;
         this.var_42.background = true;
         this.var_42.color = 33554431;
         this.var_42.tags.push("room_widget_chat");
         this.var_366 = param2.createWindow("chat_contentlist","",HabboWindowType.const_1374,HabboWindowStyle.const_47,0 | 0,new Rectangle(0,0,200,this.var_244),null,0) as IItemListWindow;
         this.var_42.addChild(this.var_366);
         this.var_131 = param2.createWindow("chat_active_content","",HabboWindowType.const_74,HabboWindowStyle.const_47,HabboWindowParam.const_65,new Rectangle(0,0,200,this.var_244),null,0) as IWindowContainer;
         this.var_131.clipping = false;
         this.var_366.addListItem(this.var_131);
         this.var_31 = new RoomChatHistoryViewer(this,param2,this.var_42,param3);
         this._baseUrl = param5.getKey("site.url");
         this.var_2517 = int(param5.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1216 && this.var_1216 > 0)
         {
            this.var_1216 = -1;
            this.animationStart();
         }
         if(this.var_959)
         {
            _loc2_ = param1 / const_1515 * const_1514;
            if(_loc2_ + this.var_985 > this.var_984)
            {
               _loc2_ = this.var_984 - this.var_985;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_985 >= this.var_984)
            {
               this.var_984 = const_117;
               this.var_985 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1216 = getTimer() + const_1069;
            }
         }
         if(this.var_31 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_491,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_900,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_730,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_491,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_900,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_730,this.onRoomViewUpdate);
      }
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               this.var_983 = param1.scale / this.var_1835;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_775.x += param1.positionDelta.x / this.var_983;
            this.var_775.y += param1.positionDelta.y / this.var_983;
         }
         if(param1.rect != null)
         {
            if(this.var_31 == null)
            ...
            this.var_42.height = this.var_244 + this.var_31.pulldownBarHeight;
            this.var_366.width = this.var_42.width - this.var_31.scrollbarWidth;
            this.var_366.height = this.var_244;
            this.var_366.x = this.var_42.x;
            this.var_366.y = this.var_42.y;
            this.var_131.width = this.var_42.width - this.var_31.scrollbarWidth;
            this.var_131.height = this.var_244;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_78.length > const_1509 || this.historyViewerActive() && this.var_78.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_984 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_78[0]);
            }
            else
            {
               this.var_984 = const_117;
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_688 + const_469 + 2)
               {
                  _loc1_.aboveLevels = const_688 + const_469 + 2;
               }
               this.var_774 = 0;
      ...
      private function checkLastItemAllowsAdding(param1:RoomChatItem) : Boolean
      {
         ...
         if(this.var_131.rectangle.bottom - (this.var_131.y + _loc2_.y + _loc2_.height) <= this.getItemSpacing(_loc2_,param1))
         {
            return false;
         }
         return true;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_469 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1510)
               {
      ...
      private function moveItemsUp(param1:int) : void
      {
         ...
         var _loc2_:* = null;
         var _loc4_:int = -1;
         var _loc5_:int = this.var_276.length - 1;
         while(_loc5_ >= 0)
         {
            _loc2_ = this.var_276[_loc5_];
            if(_loc2_ != null)
            {
               if(_loc4_ == -1)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         {
            this.var_2520 = !!this._questEngine.isTrackerVisible() ? int(const_1513) : 0;
         }
         var _loc2_:Number = (param1.senderX + this.var_775.x) * this.var_983;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_42.width / 2 - const_1067 + this.var_3035;
         var _loc6_:Number = this.var_42.width / 2 + const_1067 - this.var_31.scrollbarWidth - this.var_2520;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_117 - const_468;
            }
            else
            {
      ...
      private function setChatItemRenderable(param1:RoomChatItem) : void
      {
         if(param1 != null)
         {
            if(param1.y < -const_687)
            {
               if(param1.view != null)
               {
                  this.var_131.removeChild(param1.view);
                  param1.hideView();
               }
            }
            else if(param1.view == null)
            {
               ...
               if(param1.view != null)
               {
                  this.var_131.addChild(param1.view);
               }
            }
         }
      }
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_244 + this.var_42.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2517)
         {
            _loc2_ = this._itemList.shift();
            _loc3_ = this.var_276.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
               this.var_276.splice(_loc3_,1);
            }
            if(_loc2_.view != null)
            {
               this.var_131.removeChild(_loc2_.view);
               _loc2_.hideView();
            }
            _loc2_.dispose();
            _loc2_ = null;
      ...
      {
         return "chat_" + this.var_2518.toString() + "_item_" + (this.var_2519++).toString();
      }
      ...
      {
         var _loc2_:int = this.var_42.context.getDesktopWindow().height - 0 - const_1512;
         param1 = Math.min(param1,_loc2_);
         this.var_244 = param1 - this.var_42.y;
         this.var_42.height = this.var_244 + RoomChatHistoryPulldown.const_86;
         if(this.var_31 != null)
         {
            this.var_31.containerResized(this.var_42.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_244 = const_1068 + const_468;
         this.var_42.height = this.var_244 + this.var_31.pulldownBarHeight;
         this.var_366.width = this.var_42.width - this.var_31.scrollbarWidth;
         this.var_366.height = this.var_244;
         this.var_131.width = this.var_42.width - this.var_31.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_131.height = this.getTotalContentHeight() + const_468;
         }
         else
         {
            this.var_131.height = this.var_244;
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_1068)
         {
            if(_loc1_ <= this.var_244 + this.var_42.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1836 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1836 = false;
         }
