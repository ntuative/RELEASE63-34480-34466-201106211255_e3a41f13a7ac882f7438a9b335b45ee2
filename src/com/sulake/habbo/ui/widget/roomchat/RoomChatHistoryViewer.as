package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1575:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_200.state = RoomChatHistoryPulldown.const_266;
         ...
         this.var_53 = param2.createWindow("chatscroller","",HabboWindowType.const_1317,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_200.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_266);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_200.state == RoomChatHistoryPulldown.const_446 || this.var_200.state == RoomChatHistoryPulldown.const_646;
      }
      ...
      {
         if(!this.var_461 && !this.var_1775)
         {
            this.var_461 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_200.state = RoomChatHistoryPulldown.const_446;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_53 != null)
         {
            ...
            if(param2)
            {
               this.var_53.scrollV = this.var_664;
            }
         }
         if(this.var_200 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_460 > 0 && param2)
         {
            if(this.var_1933)
            {
               if(Math.abs(param1 - this.var_460) <= const_1295)
               {
                  return;
               }
               this.var_1933 = false;
            ...
            if(this.var_461)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_53.scrollV < 1 - const_1575 / this.var_53.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1934)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_53 != null)
         {
            this.var_664 = this.var_53.scrollV;
         }
         if(this.var_53 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_664 - this.var_53.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
