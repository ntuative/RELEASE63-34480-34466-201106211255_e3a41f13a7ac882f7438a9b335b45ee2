package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2321:int = 1000;
      ...
      private var var_655:IWindow;
      
      private var var_332:Number;
      
      private var var_536:ITextWindow;
      
      private var var_232:Timer;
      
      private var var_656:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_132 = param2;
         this._widget = param1;
         this.var_232 = new Timer(this.const_2321);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_132.isActive)
         {
            ...
            this.var_655.width = _loc2_ * this.var_332;
         }
         else
         {
            this.var_655.width = 0;
            this.var_232.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_536 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_536 == null)
            {
               return;
            }
         ...
         if(!this.var_132.isActive)
         {
            this.var_536.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_536.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_536.text;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_74,HabboWindowStyle.const_30,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_656 = this._window.findChildByName("effect_hilite");
            this.var_656.visible = false;
         }
         this.setTimeLeft();
         this.var_655 = this._window.findChildByName("loader_bar");
         if(this.var_655 != null)
         {
            this.var_332 = this.var_655.width;
            this.var_232.start();
            this.onUpdate();
         }
