package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1698:int = 152;
      
      private static const const_1700:int = 16;
      
      private static const const_723:int = 4;
      
      private static const const_1707:uint = 14342874;
      
      private static const const_1708:uint = 3815994;
      
      private static const const_1709:uint = 2085362;
      
      private static const const_1706:uint = 39616;
      
      private static const const_1702:uint = 10513106;
      
      private static const const_1705:uint = 8734654;
      
      private static const const_1710:uint = 9094430;
      
      private static const const_1701:uint = 6200576;
      
      private static const const_1699:String = "happiness";
      
      private static const const_1711:String = "experience";
      
      private static const const_1703:String = "energy";
      
      private static const const_1704:int = 250;
      
      private static const const_1148:int = 25;
      
      private static const const_1147:int = 5;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1699,param1.nutrition,param1.nutritionMax,const_1706,const_1709);
         this.updateStateElement(const_1711,param1.experience,param1.experienceMax,const_1705,const_1702);
         this.updateStateElement(const_1703,param1.energy,param1.energyMax,const_1701,const_1710);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1698,const_1700,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1707);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1708);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_231 && this.var_231.getPetId() == this.var_538)
               {
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1148 + const_1147;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1147;
            }
         }
         this.var_107.height = _loc4_ + const_1148;
         this.updateWindow();
      }
   }
}
