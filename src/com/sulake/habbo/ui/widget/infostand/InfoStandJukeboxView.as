package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_262 = var_48.findChildByTag("catalog");
         if(var_262 != null)
         {
            var_262.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_432)
         {
            this.var_2053 = param1.songId;
         }
         if(param1.songId == this.var_2053)
         {
            this._songName = param1.songName;
            this.var_2451 = param1.songAuthor;
            this.updateNowPlaying(this.var_2053 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2451;
         }
         else
         {
