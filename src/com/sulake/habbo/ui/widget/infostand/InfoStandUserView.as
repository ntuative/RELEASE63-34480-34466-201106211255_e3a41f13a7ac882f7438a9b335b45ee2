package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1108:TagListRenderer;
      ...
      private const const_2337:int = 2000;
      
      private const const_2336:int = 50;
      
      private const const_2334:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1108 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2735 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_.textColor = this.const_1604;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1115,this.const_2336);
         _loc5_.height = Math.max(_loc5_.height,this.const_2334);
         _loc3_.height = _loc5_.height + this.const_2335;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_351,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_351,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1108.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2734 > this.const_2337 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               _loc3_.textColor = this.const_1604;
            }
         }
         else
         {
