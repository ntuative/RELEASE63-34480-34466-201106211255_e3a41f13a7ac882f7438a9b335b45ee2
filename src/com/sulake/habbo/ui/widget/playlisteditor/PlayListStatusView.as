package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_895:String = "PLSV_ADD_SONGS";
      
      public static const const_1205:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_54 != const_632)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_466[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_466[const_895];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_466.add(const_632,_loc1_);
