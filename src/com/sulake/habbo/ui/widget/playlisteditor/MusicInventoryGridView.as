   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_675.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_113.playButtonState = MusicInventoryGridItem.const_1301;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_113 != null)
         {
            this.var_113.playButtonState = MusicInventoryGridItem.const_592;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_113.playButtonState == MusicInventoryGridItem.const_592)
               {
            ...
            {
               _loc4_ = this.var_675.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
