package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_554:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_554.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_554 = null;
         }
         if(this.var_47 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_554 == null)
         {
            this.var_554 = new Sprite();
            this.var_554.addChild(new Bitmap(this.var_47));
            this.var_554.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_554.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_554);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1313 != "")
         {
            HabboWebTools.openWebPage(this.var_1313);
         }
      }
   }
}
