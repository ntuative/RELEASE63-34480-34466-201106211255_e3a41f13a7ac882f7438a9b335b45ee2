package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1403:uint = 4281149991;
      
      protected static const const_1405:uint = 4282950861;
      
      protected static const const_2035:uint = 4288230144;
      
      protected static const const_1404:uint = 16777215;
      
      protected static const const_1402:uint = 9552639;
      
      protected static const const_2036:uint = 16777215;
      
      protected static const const_2034:uint = 5789011;
      
      protected static const const_2032:uint = 13947341;
      
      protected static const const_2033:uint = 5789011;
      
      private static const const_1490:int = 25;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1686 = param5;
         param1.var_2410 = param4;
         param1.var_2222 = param6;
         param1.var_1684 = false;
         param1.var_3013 = 500;
         ...
         if(param1.var_1130)
         {
            if(!param1.var_501)
            {
               param1.var_501 = new Timer(param1.var_3014,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_489));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1683)
         {
            ...
            this._blend = 1 - this.var_1685 / Number(this.var_3013);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1401)
         {
            ...
            if(this.var_1686 == RoomObjectTypeEnum.const_125 || this.var_1686 == RoomObjectTypeEnum.const_626)
            {
            ...
            if(_loc6_ < this.var_2224 - const_1053)
            {
               _loc6_ = this.var_2224 - const_1053;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2224 = _loc6_;
