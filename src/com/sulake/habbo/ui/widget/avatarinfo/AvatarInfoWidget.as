package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_800:OwnAvatarMenuView;
      
      private var var_801:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_2624 = Boolean(this.var_178.getBoolean("menu.avatar.enabled",false));
         this.var_1905 = this.var_178.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_443,this.onRoomObjectRemoved);
      ...
      {
         return var_922 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_844,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_443,this.onRoomObjectRemoved);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_367,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_806,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_436,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_367,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_436,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_436,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_123:
               ...
               if(this.var_1905 && _loc2_.allowNameChange)
               {
            ...
            case RoomWidgetRoomObjectNameEvent.const_549:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_367:
               this.var_1904 = true;
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_331:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_806:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1906 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_872,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_436:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1906)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_165:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_125,false,!!_loc3_.isSpectatorMode ? null : this.var_247);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_626,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.PET_INFO:
               if(this.var_1904)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_211,false,null);
               }
               break;
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_329,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1905) : Boolean(this.var_2624);
         }
            ...
            if(!this.var_1907)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_800)
                     {
                        this.var_800 = new OwnAvatarMenuView(this);
                     }
                  ...
                  else
                  {
                     if(!this.var_801)
                     {
                        this.var_801 = new AvatarMenuView(this);
                     }
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_210,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_210);
      }
