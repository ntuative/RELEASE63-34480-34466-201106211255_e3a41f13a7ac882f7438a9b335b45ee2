package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_894);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_886);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_743);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_894:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_886:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_743:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_151);
         _loc1_.push(FriendRequestEvent.const_59);
         _loc1_.push(FriendRequestEvent.const_218);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_151:
            ...
            case FriendRequestEvent.const_218:
