   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_253 != null)
         {
            ...
            this.var_253.events.addEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_221,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_221,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_253 != null)
         {
            ...
            this.var_253.events.removeEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
            this.var_253 = null;
         }
         this.var_1125 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_872);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_997);
         _loc1_.push(RoomWidgetFurniActionMessage.const_812);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1203);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_810);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_734);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_879);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1819);
         _loc1_.push(RoomWidgetPetCommandMessage.const_647);
         _loc1_.push(RoomWidgetPetCommandMessage.const_1010);
         _loc1_.push(RoomWidgetUserActionMessage.const_508);
         _loc1_.push(RoomWidgetUserActionMessage.const_273);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_833);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_607)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_273 || param1.type == RoomWidgetUserActionMessage.const_508 || param1.type == RoomWidgetUserActionMessage.const_638)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_872:
            ...
            case RoomWidgetUserActionMessage.const_618:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1399,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_1203:
               ...
               break;
            case RoomWidgetUserActionMessage.const_273:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_810:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_734:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_879:
            ...
            case RoomWidgetUserActionMessage.const_553:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_1010:
            ...
            case RoomWidgetPetCommandMessage.const_647:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_833:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_277);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_945) == 1)
               {
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_277);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1234);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1170);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_660)
                  {
                  ...
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_422.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_211)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_626)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_357);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_165)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_1014);
                  ...
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_838;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1789);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_161];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_161:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_1014);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_253 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_432,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_253 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_390,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
