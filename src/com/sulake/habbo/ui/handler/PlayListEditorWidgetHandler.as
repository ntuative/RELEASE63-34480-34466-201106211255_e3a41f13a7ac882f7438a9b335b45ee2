package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1480:IMessageEvent;
      
      private var var_1813:IMessageEvent;
      
      private var var_1812:IMessageEvent;
      ...
      {
         this.var_1480 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1813 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1812 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1480);
         this._connection.addMessageEvent(this.var_1813);
         this._connection.addMessageEvent(this.var_1812);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1480);
               this._connection.removeMessageEvent(this.var_1813);
               this._connection.removeMessageEvent(this.var_1812);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_892,RoomWidgetPlayListModificationMessage.const_978,RoomWidgetPlayListModificationMessage.const_764,RoomWidgetPlayListPlayStateMessage.const_805,RoomWidgetPlayListUserActionMessage.const_854];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_892:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_771,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_978:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_764:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_805:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_240);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_240:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1021,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_983,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_991));
               break;
