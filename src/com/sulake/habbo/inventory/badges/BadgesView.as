package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_723:IItemGridWindow;
      
      private var var_1114:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_723 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_723.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1114 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1114.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_723.scrollV;
         this.var_723.removeGridItems();
         this.var_1114.removeGridItems();
         var _loc2_:Array = this.var_77.getBadges(BadgesModel.const_482);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_723.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_723.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_77.getBadges(BadgesModel.const_330);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_1114.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_77.getBadges(BadgesModel.const_330);
      ...
      {
         var _loc2_:int = this.var_723.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1114.getGridItemIndex(param1.window);
