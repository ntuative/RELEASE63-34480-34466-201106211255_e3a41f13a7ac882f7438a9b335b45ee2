package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2325:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_371 = param5;
         this.var_371.events.addEventListener(BadgeImageReadyEvent.const_221,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_371.events.removeEventListener(BadgeImageReadyEvent.const_221,this.onBadgeImageReady);
            this.var_371 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_813[_loc2_] == param1)
            {
               this.var_813.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1265.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_661.indexOf(param3) != -1;
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_330);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_482);
         ...
         var _loc3_:Array = this.getBadges(const_330);
      ...
      {
         return this.getItemInIndex(param1,const_330);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_482);
      }
      ...
      {
         if(param1 == InventoryCategory.const_265 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_661.indexOf(_loc2_) == -1)
            {
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_661 && this.var_661.length > 0)
         {
