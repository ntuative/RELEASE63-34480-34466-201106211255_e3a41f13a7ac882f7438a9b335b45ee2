package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1149:uint = 4284532064;
      
      private static const const_1150:uint = 2577770;
      ...
      private var var_2154:IWindowContainer;
      
      private var var_232:Timer;
      
      private var var_1113:GroupItem;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2154 = this.createMinimizedWindow();
         }
         if(!this.var_2970)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1149) : uint(const_1150);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1149) : uint(const_1150);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1113)
         {
            this.var_1113.isSelected = false;
            this.var_1113 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1919)
            {
            ...
            this.var_722.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_546);
            this.var_722.show();
         }
         ...
         if(this.var_208.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_722.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_546);
               }
            }
            else
            {
