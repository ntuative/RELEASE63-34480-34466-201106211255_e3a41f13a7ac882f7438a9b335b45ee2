package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1802:uint = 9;
      ...
      public static const const_354:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_904 = false;
         this.var_2991 = param3;
         this.var_1675 = param4;
         this.var_2990 = param5;
         this.var_1119 = new Map();
         this.var_1380 = false;
         ...
         this.var_61.updateItemList(this.var_1675);
      ...
      public function close() : void
      {
         if(this.var_880)
         {
            if(this._state != const_226 && this._state != const_294)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_904 + " OTHER: " + this.var_1380);
         ...
         {
            case const_226:
               if(param1 == const_230 || param1 == const_294)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = this.var_303.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1388);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1380 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_61.alertPopup(TradingView.const_1254);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_303.length < const_1802)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_200)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_303.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
