package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1580:int = 13421772;
      
      private static const const_1579:int = 10275685;
      ...
      protected var var_732:BitmapData;
      ...
      protected var var_3024:BitmapData;
      
      private var var_1559:Boolean;
      
      private const const_2058:Number = 1;
      
      private const const_2057:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1614 = this._window.findChildByTag("BG_COLOR");
         this.var_2692 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2238 == FurniModelCategory.const_35)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1667));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2220);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_902)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2057;
               _loc1_.blend = this.const_2057;
            }
            else
            {
         ...
         this.var_1614.color = !!this.var_1559 ? uint(const_1579) : uint(const_1580);
         this.var_2692.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2237 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3024;
               _loc5_.visible = true;
            }
            else
            {
