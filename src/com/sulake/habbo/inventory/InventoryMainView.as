package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_473:int = 3;
      ...
      {
         return !!this.var_17 ? Boolean(this.var_17.getStateFlag(WindowState.const_91)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_778);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_129:
               ...
               break;
            case InventoryCategory.const_265:
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_367 == InventoryCategory.const_129)
            {
               this.toggleCategoryView(InventoryCategory.const_129);
            }
            else if(this.var_367 == InventoryCategory.const_76)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1841)
         {
            this.var_1841 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1841,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_473;
            _loc3_.y = const_473;
         }
         return _loc3_;
      }
