package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_439 = [];
         this.var_438 = [];
         this.var_635 = new Timer(const_1494,1);
         ...
         this.var_2485 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_767 == null)
         {
            this.var_767 = this._windowManager.buildFromXML(this.var_2485) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_767.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_767.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_35,const_46];
         var _loc5_:int = 0;
         ...
         if(param1 == InventoryCategory.const_76 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_276:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_129);
            }
         }
      }
      ...
      {
         this.var_2484 = getTimer();
         this.switchCategory(const_276);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_428);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_35,const_46];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_35,const_46];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_634.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_200)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_276)
            {
      ...
      {
         return getTimer() < this.var_2484 + const_1495;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_345 || _loc3_.category == FurniCategory.const_337 || _loc3_.category == FurniCategory.const_318)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               ...
               if(_loc4_.category == FurniCategory.const_902)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_450:
               return this.var_439.length;
            case UnseenItemCategoryEnum.const_433:
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_46:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_433));
                  this.var_438 = [];
            ...
            case const_35:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_450));
                  this.var_439 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
