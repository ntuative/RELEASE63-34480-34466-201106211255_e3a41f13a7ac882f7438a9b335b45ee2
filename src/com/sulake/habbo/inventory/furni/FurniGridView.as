   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_77.toggleItemSelection(this._category,this.var_233.getGridItemIndex(param1.window));
            this.var_588 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_588 != null && this.var_588 == param2 && !this.var_77.isTradingOpen)
         {
