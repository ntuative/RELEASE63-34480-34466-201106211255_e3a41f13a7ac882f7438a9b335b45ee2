package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_629 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_629.width;
         this.var_103 = this.var_629.height;
         this.var_1193 = param5;
         this.var_966 = param6;
         this.var_243 = Math.floor(this.var_1193 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1193,this.var_966);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_630 = this.resolveRowCountFromList();
         if(this.var_630 == 0)
         {
            this.var_29 = new BitmapData(this.var_1193,this.var_966);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_243 * this._thumbWidth,this.var_1193),Math.max(this.var_630 * this.var_103,this.var_966),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_630)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_243 && this.var_29.height < _loc3_.y * this.var_103)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_243 - 1),this.var_103);
         ...
         _loc4_ = new Rectangle(0,this.var_103,this._thumbWidth * (this.var_243 - 1),this.var_29.height - this.var_103);
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_29.height < this.var_966)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_966);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_629.width,this.var_629.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_629.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_629,this.var_629.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
