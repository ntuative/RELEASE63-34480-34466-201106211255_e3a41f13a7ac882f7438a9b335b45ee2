package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1074:int = 1;
      ...
      {
         var _loc2_:PetsGridItem = this.var_546.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_546 == null || this.var_546.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_546.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_546.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_546.add(param1.id,_loc2_);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_35);
                  break;
               case "tab_wall":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_46);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_450) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_433) > 0;
