package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1617.setSelectedGridItem(this);
               this.var_1616 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1616 = false;
                  this.var_1617.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1614)
         {
            return;
         }
         this.var_1614.color = !!this.var_1596 ? uint(const_1579) : uint(const_1580);
         this.var_2692.visible = param1;
      }
