   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_505,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_63.getValue(InventorySubCategory.const_341));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_63.getValue(InventoryCategory.const_145));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_63.getValue(InventoryCategory.const_265));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_63.getValue(InventorySubCategory.const_1187));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_63.getValue(InventoryCategory.const_129));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_63.getValue(InventoryCategory.const_428) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_505,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_81:
               this.var_1181 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_505:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_371 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_63.add(InventoryCategory.const_428,_loc1_);
         ...
         this.var_63.add(InventoryCategory.const_265,_loc3_);
         ...
         this.var_63.add(InventoryCategory.const_145,_loc4_);
         ...
         this.var_63.add(InventorySubCategory.const_341,_loc5_);
         ...
         this.var_63.add(InventorySubCategory.const_1187,_loc6_);
         ...
         this.var_63.add(InventoryCategory.const_129,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_951.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2315);
         }
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2424)
         {
            this.var_2424 = _loc1_;
