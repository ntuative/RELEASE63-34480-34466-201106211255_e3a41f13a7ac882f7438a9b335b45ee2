package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106211250));
         this.var_138 = new Map();
         this.var_138.add(HabboHelpViewEnum.const_1929,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_205,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_663,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_349,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_279,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_411,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_928,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_267,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_138.add(HabboHelpViewEnum.const_1312,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_138.add(HabboHelpViewEnum.const_1212,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_780,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_577.length == 0 || param1 != this.var_406)
            {
               this.var_577.push(this.var_406);
            }
         }
         this.var_406 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_267:
               ...
               break;
            case CallForHelpResultEnum.const_1231:
               this.showUI(HabboHelpViewEnum.const_1212);
               break;
            case CallForHelpResultEnum.const_1216:
               this.showUI(HabboHelpViewEnum.const_1312);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_138.getValue(HabboHelpViewEnum.const_205) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_516));
      }
      ...
      {
         return this.var_138.getValue(this.var_406);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2307 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2306;
         this._window.width = _loc1_.width + this.var_2307;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_406 == HabboHelpViewEnum.const_205)
         {
            return;
         }
         if(this.var_708.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_708.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_708[1],this.var_708[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_708[0],this.var_708[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_406 == HabboHelpViewEnum.const_205 || this.var_577.length == 0)
         {
            return;
         }
         if(this.var_407 == null)
