package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1884:uint = 11129827;
      ...
      private var var_1244:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1883 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_792)
         {
            this.var_792 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_792)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_793)
         {
            this.var_793 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_793)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_535);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_909:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1123:
               _loc4_.text = this.var_27.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1124:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1124 || param1 == ChangeUserNameResultMessageEvent.var_1123)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1244 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1244.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_535 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_535);
               break;
