package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      public function FriendRequestTab()
      {
         ...
         if(_window)
         {
            _window.findChildByName(const_462).visible = false;
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1509 ? var_1509 : new FriendRequestTab();
         _loc2_.var_161 = false;
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               _loc3_ = IBitmapWrapperWindow(_loc2_._window.findChildByName(const_313));
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2038).content as XML) as IWindowContainer;
         ...
         var _loc5_:IBubbleWindow = _loc1_.findChildByName(const_462) as IBubbleWindow;
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_335,WindowStyle.const_102,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_453,WindowStyle.const_102,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
         ...
         IItemListWindow(_loc1_.findChildByName(const_380)).addListItemAt(_loc7_,0);
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2037:
                  var_351.acceptFriendRequest(var_162.id);
                  break;
               case const_1413:
                  if(selected)
                  {
                  ...
                  break;
               case const_1023:
                  var_351.declineFriendRequest(var_162.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1023)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1523;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(!disposed)
         {
            if(friend)
            {
               ...
               {
                  _loc3_ = _window.findChildByName(const_313) as IBitmapWrapperWindow;
                  if(_loc3_)
                  {
                     _loc4_ = var_499.getAvatarFaceBitmap(param1.figure);
                     if(_loc4_)
                     {
