package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2042:String = "friendRequestsTabXML";
      ...
      protected static const const_462:String = "bubble";
      ...
      protected static const const_2043:String = "button_accept_all";
      
      protected static const const_2040:String = "click_area_discard_all";
      
      protected static const const_1413:String = "button_close";
      
      protected static const const_2037:String = "button_accept";
      
      protected static const const_1025:String = "click_area_discard";
      
      protected static const const_1412:String = "text_discard";
      
      private static var var_1509:FriendRequestsTab;
      
      private static const const_71:uint = 4294625561;
      
      private static const const_1070:uint = 4294957414;
      
      private static const const_1618:uint = 4289431312;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1509 ? var_1509 : new FriendRequestsTab();
      ...
      override public function recycle() : void
      {
         ...
         if(!disposed)
         {
            if(!var_161)
            {
               if(_window)
               {
                  _loc1_ = _window.findChildByName(const_462) as IBubbleWindow;
                  if(_loc1_)
                  {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            if(_window)
            {
               _loc2_ = _window.findChildByName(const_462) as IBubbleWindow;
               if(_loc2_)
               {
                  _loc2_.visible = true;
                  if(!this.var_2026)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1309.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1618) : uint(const_1619);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_681).caption = _loc5_.name;
                           _loc6_ = _loc4_.getChildByName(const_313) as IBitmapWrapperWindow;
      ...
      override public function deselect(param1:Boolean) : void
      {
         ...
         if(selected)
         {
            if(_window)
            {
               _loc2_ = _window.findChildByName(const_462);
               if(_loc2_)
               {
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         var _loc4_:IBubbleWindow = _loc1_.findChildByName(const_462) as IBubbleWindow;
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
         ...
         this.var_1309 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_ = IBitmapWrapperWindow(param1.findChildByName(const_313));
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1026)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_1413:
                  ...
                  break;
               case const_2043:
                  var_351.acceptAllFriendRequests();
                  break;
               case const_2040:
                  var_351.declineAllFriendRequests();
                  break;
               case const_2037:
                  var_351.acceptFriendRequest(param2.parent.id);
                  break;
               case const_1025:
                  var_351.declineFriendRequest(param2.parent.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1025)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1412)).textColor = const_1523;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         var _loc3_:IBubbleWindow = _window.findChildByName(const_462) as IBubbleWindow;
         if(_loc3_)
         {
            ...
            if(_loc4_)
            {
               ...
               while(_loc6_ < _loc4_.numListItems)
               {
                  ...
                  {
                     _loc7_ = _loc5_.getChildByName(const_313) as IBitmapWrapperWindow;
