package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1629:String = "addFriendsTabXML";
      
      private static const const_1630:String = "find_friends_icon_png";
      
      private static var var_1066:int = -1;
      
      private static const const_71:uint = 6907230;
      
      private static const const_1070:uint = 9209986;
      ...
      {
         var _loc1_:IWindowContainer = false ? const_478.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1629).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_459));
