package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_875:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1637:PurseExtension;
      
      private var var_1636:ClubStatusBarExtension;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_288.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_288 && this._windowManager && this._config && this._localization && this.var_13 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_875 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
            if(this._config.getBoolean("club.status.bar.enabled",false))
            {
               this.var_1636 = new ClubStatusBarExtension(this._windowManager,assets,events,this._config,this._localization,this.var_13,this._catalog,this._connection);
            }
            this.var_1637 = new PurseExtension(this._windowManager,this._assetLibrary,events,this._config,this._catalog);
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_875.showRoomInfo();
         }
         else
         {
            this.var_875.hideRoomInfo();
         }
      }
