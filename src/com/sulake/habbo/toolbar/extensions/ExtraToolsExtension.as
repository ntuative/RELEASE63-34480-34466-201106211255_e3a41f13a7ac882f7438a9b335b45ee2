package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1516:uint = 16777215;
      
      private static const const_1518:uint = 12247545;
      
      private static const const_1519:String = "HELP";
      
      private static const const_1517:String = "ROOMINFO";
      ...
      private const const_876:int = 42;
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_413 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_62.removeListItem(this.var_413);
      }
      
      public function showRoomInfo() : void
      {
         this.var_62.addListItemAt(this.var_413,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_976;
         _loc3_.y = this.const_876;
      ...
      private function showConfirmation() : void
      {
         if(!this.var_648)
         {
            this.var_648 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1517);
               break;
            case "confirm":
               if(false)
               {
