package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1532:uint = 7433577;
      
      private static const const_1526:uint = 5723213;
      ...
      private static const const_1528:int = 80;
      
      private static const const_1527:int = 74;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this.var_216.x = _loc13_.width - this.var_216.width - const_473;
         this.var_216.y = const_473;
         this.var_2539 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         if(!param1 && _loc2_ == this.var_1514)
         {
            return;
         }
         this.var_1514 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1527) : int(const_1528);
         var _loc4_:int = !!_loc2_ ? int(const_1529) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1531 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1530;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_216 != null && this.var_2539)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_907:
               _loc3_ = false;
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_471 ? this.var_1512 : this.var_1513;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_471)
         {
            param1.color = const_1532;
         }
         else
         {
            param1.color = const_1526;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1514 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1514 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1513 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1512)
         {
            this.var_1512.dispose();
         }
         this.var_1512 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_988.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_473;
            _loc2_.y = const_473;
